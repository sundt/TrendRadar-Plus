...
try:
    ...
    from hotnews.kernel.user import favorites_api
    _favorites_router = favorites_api.router
...
from hotnews.web.article_export import router as _article_export_router
app.include_router(_article_export_router)
...
# Note: run_server() is called from __main__ below
