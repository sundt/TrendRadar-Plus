import{a as T,b as re}from"./chunk-ICSVECP2.js";var Te="",ie=0,H=null,V=null,U=null,P=null,Oe=300;function Bt(){return navigator.userAgent.toLowerCase().indexOf("micromessenger")!==-1}function x(){if(Bt()){window.location.href="/api/auth/oauth/wechat-mp";return}let e=document.getElementById("loginModal");e&&(e.style.display="flex",ke(),X(1),Se())}function de(){let e=document.getElementById("loginModal");e&&(e.style.display="none"),H&&(clearInterval(H),H=null),le(),Ee(),ke();let t=document.getElementById("login-email"),o=document.getElementById("login-code");t&&(t.value=""),o&&(o.value="")}async function Se(){let e=document.getElementById("login-qr-loading"),t=document.getElementById("login-qr-image"),o=document.getElementById("login-qr-expired"),n=document.getElementById("login-qr-countdown");e&&(e.style.display="flex"),t&&(t.style.display="none"),o&&(o.style.display="none"),n&&(n.style.display="none"),le();try{let a=await(await fetch("/api/auth/wechat-qr/create",{method:"POST",headers:{"Content-Type":"application/json"}})).json();a.ok&&a.qr_url?(V=a.session_id,Oe=a.expire_seconds||300,t&&(t.src=a.qr_url,t.onload=()=>{e&&(e.style.display="none"),t.style.display="block"},t.onerror=()=>{e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent="\u52A0\u8F7D\u5931\u8D25")}),$t(Oe),Mt()):(e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent=a.message||"\u52A0\u8F7D\u5931\u8D25"))}catch(s){console.error("Failed to load WeChat QR:",s),e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent="\u7F51\u7EDC\u9519\u8BEF")}}function Ct(){Se()}function $t(e){let t=document.getElementById("login-qr-countdown"),o=document.getElementById("login-qr-countdown-text");if(!t||!o)return;let n=e;t.style.display="block";let s=()=>{let a=Math.floor(n/60),r=n%60;o.textContent=`${a}:${r.toString().padStart(2,"0")}`,n<60?t.classList.add("warning"):t.classList.remove("warning")};s(),P=setInterval(()=>{n--,n<=0?(clearInterval(P),P=null,Ne()):s()},1e3)}function Ne(){let e=document.getElementById("login-qr-image"),t=document.getElementById("login-qr-expired"),o=document.getElementById("login-qr-countdown");e&&(e.style.display="none"),t&&(t.style.display="flex",t.querySelector("span").textContent="\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F"),o&&(o.style.display="none"),le()}function Mt(){if(!V)return;let e=async()=>{let t=V;if(t)try{let n=await(await fetch(`/api/auth/wechat-qr/status?session_id=${encodeURIComponent(t)}`)).json();if(n.status==="confirmed"&&n.session_token){U&&(clearInterval(U),U=null),P&&(clearInterval(P),P=null),E("\u767B\u5F55\u6210\u529F","success");try{await fetch(`/api/auth/wechat-qr/confirm-cookie?session_id=${encodeURIComponent(t)}`,{method:"POST",headers:{"Content-Type":"application/json"}})}catch(s){console.error("Failed to set cookie:",s)}V=null,setTimeout(()=>{de(),window.location.reload()},500);return}else if(n.status==="scanned")E("\u5DF2\u626B\u7801\uFF0C\u8BF7\u5728\u624B\u673A\u4E0A\u786E\u8BA4","success");else if(n.status==="expired"){Ne();return}}catch(o){console.error("Polling error:",o)}};U=setInterval(e,2e3),e()}function le(){U&&(clearInterval(U),U=null),P&&(clearInterval(P),P=null),V=null}function xt(){let e=document.getElementById("login-main"),t=document.getElementById("login-email-form");e&&(e.style.display="none"),t&&(t.style.display="block"),le(),setTimeout(()=>{let o=document.getElementById("login-email");o&&o.focus()},100)}function ke(){let e=document.getElementById("login-main"),t=document.getElementById("login-email-form");e&&(e.style.display="block"),t&&(t.style.display="none"),X(1),Ee(),Se()}function At(e){e.target.id==="loginModal"&&de()}function E(e,t){let o=document.getElementById("login-message");o&&(o.textContent=e,o.className="login-message "+t)}function Ee(){let e=document.getElementById("login-message");e&&(e.className="login-message")}function X(e){document.querySelectorAll(".login-step").forEach(o=>o.classList.remove("active"));let t=document.getElementById("login-step-"+e);t&&t.classList.add("active"),document.querySelectorAll(".login-step-dot").forEach((o,n)=>{o.classList.toggle("active",n<e)}),Ee()}function Ft(){X(1),H&&(clearInterval(H),H=null)}function Re(){ie=60;let e=document.getElementById("login-resend-btn"),t=document.getElementById("login-resend-text");e&&(e.disabled=!0),H=setInterval(()=>{ie--,ie<=0?(clearInterval(H),H=null,e&&(e.disabled=!1),t&&(t.textContent="\u91CD\u65B0\u53D1\u9001")):t&&(t.textContent=ie+"\u79D2\u540E\u91CD\u53D1")},1e3)}async function Ht(e){e.preventDefault();let t=document.getElementById("login-send-btn"),o=document.getElementById("login-email").value.trim();if(!o){E("\u8BF7\u8F93\u5165\u90AE\u7BB1","error");return}t&&(t.disabled=!0,t.textContent="\u53D1\u9001\u4E2D...");try{let n=await fetch("/api/auth/send-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o})}),s=await n.json();if(n.ok){Te=o;let a=document.getElementById("login-display-email");a&&(a.textContent=o),X(2);let r=document.getElementById("login-code");r&&r.focus(),Re()}else{let a=typeof s.detail=="string"?s.detail:s.detail?.[0]?.msg||s.message||"\u53D1\u9001\u5931\u8D25";E(a,"error")}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error")}t&&(t.disabled=!1,t.textContent="\u83B7\u53D6\u9A8C\u8BC1\u7801")}async function Pt(){let e=document.getElementById("login-resend-btn");e&&(e.disabled=!0);try{let t=await fetch("/api/auth/send-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Te})}),o=await t.json();if(t.ok)E("\u9A8C\u8BC1\u7801\u5DF2\u91CD\u65B0\u53D1\u9001","success"),Re();else{let n=typeof o.detail=="string"?o.detail:o.detail?.[0]?.msg||o.message||"\u53D1\u9001\u5931\u8D25";E(n,"error"),e&&(e.disabled=!1)}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error"),e&&(e.disabled=!1)}}async function qt(e){e.preventDefault();let t=document.getElementById("login-verify-btn"),o=document.getElementById("login-code").value.trim();if(!o||o.length!==6){E("\u8BF7\u8F93\u51656\u4F4D\u9A8C\u8BC1\u7801","error");return}t&&(t.disabled=!0,t.textContent="\u767B\u5F55\u4E2D...");try{let n=await fetch("/api/auth/verify-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Te,code:o})}),s=await n.json();if(n.ok)E("\u767B\u5F55\u6210\u529F","success"),setTimeout(()=>{de(),window.location.reload()},500);else{let a=typeof s.detail=="string"?s.detail:s.detail?.[0]?.msg||s.message||"\u9A8C\u8BC1\u5931\u8D25";E(a,"error")}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error")}t&&(t.disabled=!1,t.textContent="\u767B\u5F55")}function De(){let e=document.getElementById("login-code");e&&e.addEventListener("input",function(o){this.value=this.value.replace(/[^0-9]/g,"").slice(0,6)});let t=new URLSearchParams(window.location.search);if(t.get("need_login")==="1"){t.delete("need_login");let o=t.toString()?window.location.pathname+"?"+t.toString():window.location.pathname;window.history.replaceState({},"",o),setTimeout(()=>{x()},100)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",De):De();window.openLoginModal=x;window.closeLoginModal=de;window.closeLoginModalOnOverlay=At;window.loginSendCode=Ht;window.loginVerifyCode=qt;window.loginResendCode=Pt;window.loginGoBack=Ft;window.loginGoToStep=X;window.loginShowMessage=E;window.loginShowEmailForm=xt;window.loginHideEmailForm=ke;window.refreshWechatQR=Ct;var L=[],z=!1,ze=!1,Ge=!1,Je=null;function j(){return T.getUser()?!0:(x(),!1)}async function Ot(e=null){let t="/api/user/todos";e&&(t+=`?group_id=${encodeURIComponent(e)}`);let o=await fetch(t);if(!o.ok){if(o.status===401)return[];throw new Error("\u83B7\u53D6 Todo \u5931\u8D25")}return(await o.json()).todos||[]}async function Dt(e){let t=await fetch("/api/user/todos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u6DFB\u52A0\u5931\u8D25")}return await t.json()}async function Nt(e,t){let o=await fetch(`/api/user/todos/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!o.ok){let n=await o.json();throw new Error(n.detail||"\u66F4\u65B0\u5931\u8D25")}return await o.json()}async function Rt(e){let t=await fetch(`/api/user/todos/${e}`,{method:"DELETE"});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u5220\u9664\u5931\u8D25")}return await t.json()}async function Ut(e){let t=await fetch("/api/user/todos/batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({todos:e})});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u6279\u91CF\u6DFB\u52A0\u5931\u8D25")}return await t.json()}async function _e(){if(!j())return[];try{return L=await Ot(),K(),L}catch(e){return console.error("[Todo] Load error:",e),[]}}async function G(e,t){if(!j())return null;try{let o=await Dt({text:e,group_id:t.groupId,group_title:t.groupTitle,group_url:t.groupUrl||"",is_custom_group:t.isCustom||!1});if(o.ok&&o.todo)return L.unshift(o.todo),K(),$("\u5DF2\u6DFB\u52A0\u5230 Todo"),o.todo}catch(o){o.message.includes("\u5DF2\u5B58\u5728")?$("\u8BE5 Todo \u5DF2\u5B58\u5728"):$("\u6DFB\u52A0\u5931\u8D25: "+o.message),console.error("[Todo] Add error:",o)}return null}async function jt(e){if(!j())return;let t=L.find(n=>n.id===e);if(!t)return;let o=!t.done;try{await Nt(e,{done:o}),t.done=o,Y(),fe(),K()}catch(n){console.error("[Todo] Toggle error:",n),$("\u66F4\u65B0\u5931\u8D25")}}async function Wt(e){if(j())try{await Rt(e),L=L.filter(t=>t.id!==e),Y(),fe(),K(),$("\u5DF2\u5220\u9664")}catch(t){console.error("[Todo] Delete error:",t),$("\u5220\u9664\u5931\u8D25")}}async function Be(e,t){if(!j())return null;let o=e.map(n=>({text:n,group_id:t.groupId,group_title:t.groupTitle,group_url:t.groupUrl||"",is_custom_group:t.isCustom||!1}));try{let n=await Ut(o);if(n.ok){n.added&&n.added.length>0&&(L=[...n.added,...L],K());let s=n.skipped_count>0?`\u5DF2\u6DFB\u52A0 ${n.added_count} \u9879\uFF0C${n.skipped_count} \u9879\u5DF2\u5B58\u5728`:`\u5DF2\u6DFB\u52A0 ${n.added_count} \u9879\u5230 Todo`;return $(s),n}}catch(n){console.error("[Todo] Batch add error:",n),$("\u6279\u91CF\u6DFB\u52A0\u5931\u8D25")}return null}function Ce(e){return L.filter(t=>t.source.groupId===e)}function zt(){return L.filter(e=>!e.done).length}function Gt(){let e={};for(let t of L){let o=t.source.groupId;e[o]||(e[o]={groupId:o,groupTitle:t.source.groupTitle,groupUrl:t.source.groupUrl,isCustom:t.source.isCustom,todos:[]}),e[o].todos.push(t)}return Object.values(e)}function A(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function $(e){if(window.showToast)window.showToast(e);else{let t=document.createElement("div");t.className="todo-toast",t.textContent=e,document.body.appendChild(t),setTimeout(()=>t.classList.add("show"),10),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>t.remove(),300)},2e3)}}function K(){let e=document.getElementById("todoBadge");if(!e)return;let t=zt();t>0?(e.textContent=t>99?"99+":t,e.classList.add("show")):e.classList.remove("show")}var Qe="todo_sidebar_width",Jt=320,Qt=800;function Vt(){if(document.getElementById("todoSidebar"))return;let e=document.createElement("div");e.id="todoSidebarBackdrop",e.className="todo-sidebar-backdrop",document.body.appendChild(e),document.body.insertAdjacentHTML("beforeend",`
    ...
    `);let o=e.querySelector(".todo-group-name-input"),n=e.querySelector(".todo-group-create-btn"),s=e.querySelector(".todo-group-cancel-btn");o.focus();let a=()=>{let r=o.value.trim();if(!r){$("\u8BF7\u8F93\u5165\u6807\u9898\u540D\u79F0");return}let d=`custom_${Date.now()}`;$e(d,r,"",!0),e.querySelector(".todo-new-group-input")?.remove()};n.addEventListener("click",a),s.addEventListener("click",()=>{e.querySelector(".todo-new-group-input")?.remove()}),o.addEventListener("keydown",r=>{r.key==="Enter"&&a(),r.key==="Escape"&&e.querySelector(".todo-new-group-input")?.remove()})}function $e(e,t,o,n){let s=document.getElementById("todoSidebarBody");if(!s)return;let a=s.querySelector(`.todo-group[data-group-id="${e}"]`);if(a){a.classList.remove("collapsed");let c=ce();c[e]=!1,Ie(c)}else{let c=ce();c[e]=!1,Ie(c);let f=`
            <div class="todo-group" data-group-id="${A(e)}">
                <div class="todo-group-header">
                    <span class="todo-group-toggle">\u25BC</span>
                    <span class="todo-group-title" title="${A(t)}">${A(t)}</span>
    ...
    `);let l=r.querySelector(".todo-text-input"),m=r.querySelector(".todo-add-confirm-btn");l.focus();let i=async()=>{let c=l.value.trim();if(!c){$("\u8BF7\u8F93\u5165 Todo \u5185\u5BB9");return}await G(c,{groupId:e,groupTitle:t,groupUrl:o||"",isCustom:n||!1})&&(l.value="",Y())};m.addEventListener("click",i),l.addEventListener("keydown",c=>{c.key==="Enter"&&i(),c.key==="Escape"&&r.querySelector(".todo-add-input")?.remove()})}function Y(){let e=document.getElementById("todoSidebarBody");if(!e)return;if((z?L:L.filter(s=>!s.done)).length===0){e.innerHTML='<div class="todo-empty">\u6682\u65E0 Todo</div>';return}let o=Gt(),n="";for(let s of o){let a=z?s.todos:s.todos.filter(f=>!f.done);if(a.length===0&&!z)continue;let r=s.todos.filter(f=>!f.done).length,d=s.todos.length,l=Ue(s.groupId),i=s.isCustom?"":`
            <button class="todo-group-summary-btn" title="\u67E5\u770B\u603B\u7ED3" data-group-id="${A(s.groupId)}" data-group-title="${A(s.groupTitle)}" data-group-url="${A(s.groupUrl||"")}">\u2728</button>
        `,c=s.groupUrl?`
            <a href="${A(s.groupUrl)}" target="_blank" rel="noopener noreferrer" class="todo-group-link-btn" title="\u67E5\u770B\u539F\u6587" onclick="event.stopPropagation()">\u{1F517}</a>
        `:"";n+=`
            <div class="todo-group ${l?"collapsed":""}" data-group-id="${A(s.groupId)}">
                <div class="todo-group-header">
                    <span class="todo-group-toggle">\u25BC</span>
                    <span class="todo-group-title" title="${A(s.groupTitle)}">${A(s.groupTitle)}</span>
        ...
        <div class="todo-item ${e.done?"done":""}" data-id="${e.id}">
            ...
            <span class="todo-text">${A(e.text)}</span>
...
`),t=t.replace(/<p>\s*<\/p>/g,""),t=t.replace(/<p><hr><\/p>/g,"<hr>"),t=t.replace(/<p>(<table>)/g,"$1"),t=t.replace(/(<\/table>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/<p>(<blockquote>)/g,"$1"),t=t.replace(/(<\/blockquote>)<\/p>/g,"$1"),t=t.replace(/(<h[1-3]>(?:✅\s*|📋\s*)?行动清单\s*<\/h[1-3]>)/gi,'<div class="action-list-header">$1<button class="action-list-add-btn" onclick="addActionListToTodo()">+ Todo</button></div>'),t}function rt(){if(document.getElementById("summaryModal"))return;document.body.insertAdjacentHTML("beforeend",`
    ...
    `)}async function He(e,t,o,n,s){if(!T.getUser()){x();return}rt();let r=document.getElementById("summaryModal"),d=document.getElementById("summaryModalTitle"),l=document.getElementById("summaryModalBody"),m=document.getElementById("summaryModalFooter");if(y=e,_=t,W=o,tt=n,ot=s,ge=!0,window._currentSummaryNewsId=e,window._currentSummaryNewsTitle=t,window._currentSummaryNewsUrl=o,et(),d){let i=t&&t.length>50?t.substring(0,50)+"...":t||"AI \u603B\u7ED3";d.textContent=`\u2728 ${i}`}r.classList.add("open"),document.body.style.overflow="hidden",l.innerHTML=`
...
`);for(let Q of g)if(Q.startsWith("data: "))try{let u=JSON.parse(Q.slice(6));switch(u.type){case"status":let ae=document.getElementById("summaryStatusText");ae&&(ae.textContent=u.message);break;case"type":S=u.article_type,C=u.article_type_name,window._currentTypeConfidence=u.confidence||0;break;case"chunk":D||(D=!0,I(),l.innerHTML=`
                                ...
                                `),h+=u.content;let N=document.getElementById("summaryStreamContent");if(N){let v=h;v=v.replace(/\[TAGS_?START\][\s\S]*$/gi,""),N.innerHTML=O(v)+'<span class="summary-cursor">\u258C</span>',N.scrollTop=N.scrollHeight}break;case"cached":I(),h=u.summary,S=u.article_type,C=u.article_type_name,F=u.token_usage||null;let M=u.feedback||null,Et=u.token_balance!==void 0?{token_balance:u.token_balance,tokens_used:u.tokens_used,default_tokens:1e5}:null,Lt=Ae(h);if(l.innerHTML=`
                                <div class="summary-content">
                                    ${O(Lt)}
                                </div>
                            `,pe(o,S,C,!0,F,M,Et),ye(e,!0),u.tags&&window.ArticleTags){console.log("[Summary] Applying cached tags for newsId:",e,"tags:",u.tags);let v=document.querySelector(`.news-item[data-news-id="${e}"]`);v||(v=document.querySelector(`.news-item[data-url="${o}"]`)),v&&(console.log("[Summary] Found news item for cached, applying tags"),window.ArticleTags.applyTags(v,u.tags),v.dataset.tagsLoaded="true")}return;case"done":F=u.token_usage||null;let It=u.token_balance!==void 0?{token_balance:u.token_balance,tokens_used:u.tokens_used,default_tokens:1e5}:null,be=document.getElementById("summaryStreamContent");if(be){be.classList.remove("summary-streaming");let v=Ae(h);be.innerHTML=O(v)}let _t=window._currentTypeConfidence||0;if(pe(o,S,C,!1,F,null,It,_t),ye(e,!0),u.tags&&window.ArticleTags){console.log("[Summary] Applying tags for newsId:",e,"tags:",u.tags);let v=document.querySelector(`.news-item[data-news-id="${e}"]`);v||(v=document.querySelector(`.news-item[data-url="${o}"]`)),v?(console.log("[Summary] Found news item, applying tags"),window.ArticleTags.applyTags(v,u.tags),v.dataset.tagsLoaded="true"):console.log("[Summary] News item not found in DOM")}break;case"short_content":I(),l.innerHTML=`
            ...
            `}}}function pe(e,t,o,n,s,a=null,r=null,d=null){let l=document.getElementById("summaryModalFooter"),m=uo[t]||"\u{1F4DD}",i="",c=s?.total_tokens||0;c>0&&(i=`<span class="summary-token-tag" title="\u672C\u6B21\u6D88\u8017">\u{1FA99} ${mo(c)}</span>`);let f=a==="up"?"active":"",p=a==="down"?"active":"";l.innerHTML=`
...
`);for(let se of k)if(se.startsWith("data: "))try{let g=JSON.parse(se.slice(6));switch(g.type){case"status":let Q=document.getElementById("summaryStatusText");Q&&(Q.textContent=g.message);break;case"type":p=g.article_type,h=g.article_type_name;break;case"chunk":S||(S=!0,I(),d.innerHTML=`
            ...
            `;else{let c=m.message||"\u672A\u77E5\u9519\u8BEF";d.innerHTML=`
                <div class="summary-access-error">
                    <div class="summary-access-error-icon">\u274C</div>
                    <div class="summary-access-error-title">\u603B\u7ED3\u5931\u8D25</div>
                    <div class="summary-access-error-text">${c}</div>
                    <div class="summary-access-error-actions">
                        <button class="summary-retry-btn" onclick="retrySummaryModal()">\u91CD\u8BD5</button>
                        <a href="${o}" target="_blank" rel="noopener noreferrer" class="summary-view-original-btn">
                            \u{1F4D6} \u9605\u8BFB\u539F\u6587
    ...
    `;t.innerHTML=o}function lt(){let e=document.getElementById("favoritesPanelBody");if(!e)return;let t=he();t.length>0?e.innerHTML=`
        ...
        `;return}_o(o.favorites)}function Bo(){if(!T.getUser()){x();return}let t=document.getElementById("favoritesPanel"),o=document.getElementById("favoritesOverlay");t&&(o||(o=document.createElement("div"),o.id="favoritesOverlay",o.className="favorites-overlay",o.onclick=Tt,document.body.appendChild(o)),we=!we,we?(t.classList.add("open"),o.classList.add("open"),bt()):(t.classList.remove("open"),o.classList.remove("open")))}function Tt(){let e=document.getElementById("favoritesPanel"),t=document.getElementById("favoritesOverlay");we=!1,e&&e.classList.remove("open"),t&&t.classList.remove("open")}async function Co(e){if((await gt(e)).ok){let o=document.querySelector(`.favorite-item[data-news-id="${e}"]`);o&&o.remove();let n=document.querySelector(`.news-favorite-btn[data-news-id="${e}"]`);n&&(n.classList.remove("favorited"),n.textContent="\u2606");let s=document.querySelector(".favorites-list");s&&s.children.length===0&&bt()}}function $o(e,t,o,n,s,a){if(e.preventDefault(),e.stopPropagation(),!T.getUser()){x();return}let d=e.currentTarget;wt({news_id:t,title:o,url:n,source_id:s||"",source_name:a||""},d)}function Mo(){try{let e=localStorage.getItem(pt);if(e){let t=parseInt(e,10);if(t>=Pe&&t<=qe)return t}}catch{}return Eo}function ct(e){try{localStorage.setItem(pt,String(e)),re.saveSidebarWidths({favorites_width:e})}catch{}}function xo(e){let t=document.getElementById("favoritesPanel");t&&(t.style.width=e+"px")}function ut(){let e=document.getElementById("favoritesPanel"),t=document.getElementById("favoritesResizeHandle");if(!e||!t)return;let o=Mo();xo(o);let n=0,s=0;function a(c){c.preventDefault(),R=!0,n=c.clientX,s=e.offsetWidth,e.classList.add("resizing"),t.classList.add("active"),document.addEventListener("mousemove",r),document.addEventListener("mouseup",d)}function r(c){if(!R)return;let f=n-c.clientX,p=s+f;p=Math.max(Pe,Math.min(qe,p)),e.style.width=p+"px"}function d(){R&&(R=!1,e.classList.remove("resizing"),t.classList.remove("active"),document.removeEventListener("mousemove",r),document.removeEventListener("mouseup",d),ct(e.offsetWidth))}function l(c){c.touches.length===1&&(c.preventDefault(),R=!0,n=c.touches[0].clientX,s=e.offsetWidth,e.classList.add("resizing"),t.classList.add("active"),document.addEventListener("touchmove",m,{passive:!1}),document.addEventListener("touchend",i))}function m(c){if(!R||c.touches.length!==1)return;c.preventDefault();let f=n-c.touches[0].clientX,p=s+f;p=Math.max(Pe,Math.min(qe,p)),e.style.width=p+"px"}function i(){R&&(R=!1,e.classList.remove("resizing"),t.classList.remove("active"),document.removeEventListener("touchmove",m),document.removeEventListener("touchend",i),ct(e.offsetWidth))}t.addEventListener("mousedown",a),t.addEventListener("touchstart",l,{passive:!1})}function mt(){document.addEventListener("click",e=>{let t=e.target.closest(".news-favorite-btn");if(!t)return;if(e.preventDefault(),e.stopPropagation(),!T.getUser()){x();return}let n=t.closest(".news-item");if(!n)return;let s=n.dataset.id||n.dataset.newsId,a=n.dataset.url,r=n.querySelector(".news-title"),d=r?r.textContent.trim():"",l=n.closest(".platform-card"),m=l?l.dataset.platform:"",i=l?l.querySelector(".platform-name"):null,c=i?i.textContent.replace("\u{1F4F1}","").trim():"";wt({news_id:s,title:d,url:a,source_id:m,source_name:c},t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ut(),mt()}):(ut(),mt());async function St(e){let t=document.getElementById(`summary-${e}`),o=document.querySelector(`.favorite-item[data-news-id="${e}"] .favorite-summary-btn`);if(!(!t||!o)){if(o.classList.contains("has-summary")){kt(e);return}o.disabled=!0,o.textContent="\u23F3",o.title="\u751F\u6210\u4E2D...",t.style.display="block",t.innerHTML=`
        <div class="summary-loading">
            <div class="summary-loading-spinner"></div>
