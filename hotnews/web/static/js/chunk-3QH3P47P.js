import{a as T,b as re}from"./chunk-ICSVECP2.js";var Te="",ie=0,H=null,V=null,U=null,P=null,De=300;function Bt(){return navigator.userAgent.toLowerCase().indexOf("micromessenger")!==-1}function F(){if(Bt()){window.location.href="/api/auth/oauth/wechat-mp";return}let e=document.getElementById("loginModal");e&&(e.style.display="flex",ke(),X(1),Se())}function de(){let e=document.getElementById("loginModal");e&&(e.style.display="none"),H&&(clearInterval(H),H=null),le(),Ee(),ke();let t=document.getElementById("login-email"),o=document.getElementById("login-code");t&&(t.value=""),o&&(o.value="")}async function Se(){let e=document.getElementById("login-qr-loading"),t=document.getElementById("login-qr-image"),o=document.getElementById("login-qr-expired"),n=document.getElementById("login-qr-countdown");e&&(e.style.display="flex"),t&&(t.style.display="none"),o&&(o.style.display="none"),n&&(n.style.display="none"),le();try{let a=await(await fetch("/api/auth/wechat-qr/create",{method:"POST",headers:{"Content-Type":"application/json"}})).json();a.ok&&a.qr_url?(V=a.session_id,De=a.expire_seconds||300,t&&(t.src=a.qr_url,t.onload=()=>{e&&(e.style.display="none"),t.style.display="block"},t.onerror=()=>{e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent="\u52A0\u8F7D\u5931\u8D25")}),xt(De),Mt()):(e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent=a.message||"\u52A0\u8F7D\u5931\u8D25"))}catch(s){console.error("Failed to load WeChat QR:",s),e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent="\u7F51\u7EDC\u9519\u8BEF")}}function $t(){Se()}function xt(e){let t=document.getElementById("login-qr-countdown"),o=document.getElementById("login-qr-countdown-text");if(!t||!o)return;let n=e;t.style.display="block";let s=()=>{let a=Math.floor(n/60),r=n%60;o.textContent=`${a}:${r.toString().padStart(2,"0")}`,n<60?t.classList.add("warning"):t.classList.remove("warning")};s(),P=setInterval(()=>{n--,n<=0?(clearInterval(P),P=null,Re()):s()},1e3)}function Re(){let e=document.getElementById("login-qr-image"),t=document.getElementById("login-qr-expired"),o=document.getElementById("login-qr-countdown");e&&(e.style.display="none"),t&&(t.style.display="flex",t.querySelector("span").textContent="\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F"),o&&(o.style.display="none"),le()}function Mt(){if(!V)return;let e=async()=>{let t=V;if(t)try{let n=await(await fetch(`/api/auth/wechat-qr/status?session_id=${encodeURIComponent(t)}`)).json();if(n.status==="confirmed"&&n.session_token){U&&(clearInterval(U),U=null),P&&(clearInterval(P),P=null),E("\u767B\u5F55\u6210\u529F","success");try{await fetch(`/api/auth/wechat-qr/confirm-cookie?session_id=${encodeURIComponent(t)}`,{method:"POST",headers:{"Content-Type":"application/json"}})}catch(s){console.error("Failed to set cookie:",s)}V=null,setTimeout(()=>{de(),window.location.reload()},500);return}else if(n.status==="scanned")E("\u5DF2\u626B\u7801\uFF0C\u8BF7\u5728\u624B\u673A\u4E0A\u786E\u8BA4","success");else if(n.status==="expired"){Re();return}}catch(o){console.error("Polling error:",o)}};U=setInterval(e,2e3),e()}function le(){U&&(clearInterval(U),U=null),P&&(clearInterval(P),P=null),V=null}function At(){let e=document.getElementById("login-main"),t=document.getElementById("login-email-form");e&&(e.style.display="none"),t&&(t.style.display="block"),le(),setTimeout(()=>{let o=document.getElementById("login-email");o&&o.focus()},100)}function ke(){let e=document.getElementById("login-main"),t=document.getElementById("login-email-form");e&&(e.style.display="block"),t&&(t.style.display="none"),X(1),Ee(),Se()}function Ft(e){e.target.id==="loginModal"&&de()}function E(e,t){let o=document.getElementById("login-message");o&&(o.textContent=e,o.className="login-message "+t)}function Ee(){let e=document.getElementById("login-message");e&&(e.className="login-message")}function X(e){document.querySelectorAll(".login-step").forEach(o=>o.classList.remove("active"));let t=document.getElementById("login-step-"+e);t&&t.classList.add("active"),document.querySelectorAll(".login-step-dot").forEach((o,n)=>{o.classList.toggle("active",n<e)}),Ee()}function Ht(){X(1),H&&(clearInterval(H),H=null)}function Ue(){ie=60;let e=document.getElementById("login-resend-btn"),t=document.getElementById("login-resend-text");e&&(e.disabled=!0),H=setInterval(()=>{ie--,ie<=0?(clearInterval(H),H=null,e&&(e.disabled=!1),t&&(t.textContent="\u91CD\u65B0\u53D1\u9001")):t&&(t.textContent=ie+"\u79D2\u540E\u91CD\u53D1")},1e3)}async function Pt(e){e.preventDefault();let t=document.getElementById("login-send-btn"),o=document.getElementById("login-email").value.trim();if(!o){E("\u8BF7\u8F93\u5165\u90AE\u7BB1","error");return}t&&(t.disabled=!0,t.textContent="\u53D1\u9001\u4E2D...");try{let n=await fetch("/api/auth/send-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o})}),s=await n.json();if(n.ok){Te=o;let a=document.getElementById("login-display-email");a&&(a.textContent=o),X(2);let r=document.getElementById("login-code");r&&r.focus(),Ue()}else{let a=typeof s.detail=="string"?s.detail:s.detail?.[0]?.msg||s.message||"\u53D1\u9001\u5931\u8D25";E(a,"error")}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error")}t&&(t.disabled=!1,t.textContent="\u83B7\u53D6\u9A8C\u8BC1\u7801")}async function qt(){let e=document.getElementById("login-resend-btn");e&&(e.disabled=!0);try{let t=await fetch("/api/auth/send-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Te})}),o=await t.json();if(t.ok)E("\u9A8C\u8BC1\u7801\u5DF2\u91CD\u65B0\u53D1\u9001","success"),Ue();else{let n=typeof o.detail=="string"?o.detail:o.detail?.[0]?.msg||o.message||"\u53D1\u9001\u5931\u8D25";E(n,"error"),e&&(e.disabled=!1)}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error"),e&&(e.disabled=!1)}}async function Ot(e){e.preventDefault();let t=document.getElementById("login-verify-btn"),o=document.getElementById("login-code").value.trim();if(!o||o.length!==6){E("\u8BF7\u8F93\u51656\u4F4D\u9A8C\u8BC1\u7801","error");return}t&&(t.disabled=!0,t.textContent="\u767B\u5F55\u4E2D...");try{let n=await fetch("/api/auth/verify-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Te,code:o})}),s=await n.json();if(n.ok)E("\u767B\u5F55\u6210\u529F","success"),setTimeout(()=>{de(),window.location.reload()},500);else{let a=typeof s.detail=="string"?s.detail:s.detail?.[0]?.msg||s.message||"\u9A8C\u8BC1\u5931\u8D25";E(a,"error")}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error")}t&&(t.disabled=!1,t.textContent="\u767B\u5F55")}function Ne(){let e=document.getElementById("login-code");e&&e.addEventListener("input",function(t){this.value=this.value.replace(/[^0-9]/g,"").slice(0,6)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ne):Ne();window.openLoginModal=F;window.closeLoginModal=de;window.closeLoginModalOnOverlay=Ft;window.loginSendCode=Pt;window.loginVerifyCode=Ot;window.loginResendCode=qt;window.loginGoBack=Ht;window.loginGoToStep=X;window.loginShowMessage=E;window.loginShowEmailForm=At;window.loginHideEmailForm=ke;window.refreshWechatQR=$t;var L=[],z=!1,Ge=!1,Je=!1,Qe=null;function j(){return T.getUser()?!0:(F(),!1)}async function Dt(e=null){let t="/api/user/todos";e&&(t+=`?group_id=${encodeURIComponent(e)}`);let o=await fetch(t);if(!o.ok){if(o.status===401)return[];throw new Error("\u83B7\u53D6 Todo \u5931\u8D25")}return(await o.json()).todos||[]}async function Nt(e){let t=await fetch("/api/user/todos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u6DFB\u52A0\u5931\u8D25")}return await t.json()}async function Rt(e,t){let o=await fetch(`/api/user/todos/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!o.ok){let n=await o.json();throw new Error(n.detail||"\u66F4\u65B0\u5931\u8D25")}return await o.json()}async function Ut(e){let t=await fetch(`/api/user/todos/${e}`,{method:"DELETE"});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u5220\u9664\u5931\u8D25")}return await t.json()}async function jt(e){let t=await fetch("/api/user/todos/batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({todos:e})});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u6279\u91CF\u6DFB\u52A0\u5931\u8D25")}return await t.json()}async function Ie(){if(!j())return[];try{return L=await Dt(),K(),L}catch(e){return console.error("[Todo] Load error:",e),[]}}async function G(e,t){if(!j())return null;try{let o=await Nt({text:e,group_id:t.groupId,group_title:t.groupTitle,group_url:t.groupUrl||"",is_custom_group:t.isCustom||!1});if(o.ok&&o.todo)return L.unshift(o.todo),K(),$("\u5DF2\u6DFB\u52A0\u5230 Todo"),o.todo}catch(o){o.message.includes("\u5DF2\u5B58\u5728")?$("\u8BE5 Todo \u5DF2\u5B58\u5728"):$("\u6DFB\u52A0\u5931\u8D25: "+o.message),console.error("[Todo] Add error:",o)}return null}async function Wt(e){if(!j())return;let t=L.find(n=>n.id===e);if(!t)return;let o=!t.done;try{await Rt(e,{done:o}),t.done=o,Y(),pe(),K()}catch(n){console.error("[Todo] Toggle error:",n),$("\u66F4\u65B0\u5931\u8D25")}}async function zt(e){if(j())try{await Ut(e),L=L.filter(t=>t.id!==e),Y(),pe(),K(),$("\u5DF2\u5220\u9664")}catch(t){console.error("[Todo] Delete error:",t),$("\u5220\u9664\u5931\u8D25")}}async function Ce(e,t){if(!j())return null;let o=e.map(n=>({text:n,group_id:t.groupId,group_title:t.groupTitle,group_url:t.groupUrl||"",is_custom_group:t.isCustom||!1}));try{let n=await jt(o);if(n.ok){n.added&&n.added.length>0&&(L=[...n.added,...L],K());let s=n.skipped_count>0?`\u5DF2\u6DFB\u52A0 ${n.added_count} \u9879\uFF0C${n.skipped_count} \u9879\u5DF2\u5B58\u5728`:`\u5DF2\u6DFB\u52A0 ${n.added_count} \u9879\u5230 Todo`;return $(s),n}}catch(n){console.error("[Todo] Batch add error:",n),$("\u6279\u91CF\u6DFB\u52A0\u5931\u8D25")}return null}function Be(e){return L.filter(t=>t.source.groupId===e)}function Gt(){return L.filter(e=>!e.done).length}function Jt(){let e={};for(let t of L){let o=t.source.groupId;e[o]||(e[o]={groupId:o,groupTitle:t.source.groupTitle,groupUrl:t.source.groupUrl,isCustom:t.source.isCustom,todos:[]}),e[o].todos.push(t)}return Object.values(e)}function M(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function $(e){if(window.showToast)window.showToast(e);else{let t=document.createElement("div");t.className="todo-toast",t.textContent=e,document.body.appendChild(t),setTimeout(()=>t.classList.add("show"),10),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>t.remove(),300)},2e3)}}function K(){let e=document.getElementById("todoBadge");if(!e)return;let t=Gt();t>0?(e.textContent=t>99?"99+":t,e.classList.add("show")):e.classList.remove("show")}var Ve="todo_sidebar_width",Qt=320,Vt=800;function Xt(){if(document.getElementById("todoSidebar"))return;let e=document.createElement("div");e.id="todoSidebarBackdrop",e.className="todo-sidebar-backdrop",document.body.appendChild(e),document.body.insertAdjacentHTML("beforeend",`
    ...
    `);let o=e.querySelector(".todo-group-name-input"),n=e.querySelector(".todo-group-create-btn"),s=e.querySelector(".todo-group-cancel-btn");o.focus();let a=()=>{let r=o.value.trim();if(!r){$("\u8BF7\u8F93\u5165\u6807\u9898\u540D\u79F0");return}let d=`custom_${Date.now()}`;$e(d,r,"",!0),e.querySelector(".todo-new-group-input")?.remove()};n.addEventListener("click",a),s.addEventListener("click",()=>{e.querySelector(".todo-new-group-input")?.remove()}),o.addEventListener("keydown",r=>{r.key==="Enter"&&a(),r.key==="Escape"&&e.querySelector(".todo-new-group-input")?.remove()})}function $e(e,t,o,n){let s=document.getElementById("todoSidebarBody");if(!s)return;let a=s.querySelector(`.todo-group[data-group-id="${e}"]`);if(a){a.classList.remove("collapsed");let u=ce();u[e]=!1,_e(u)}else{let u=ce();u[e]=!1,_e(u);let p=`
        ...
        `;s.insertAdjacentHTML("afterbegin",p),a=s.querySelector(`.todo-group[data-group-id="${e}"]`),a.querySelector(".todo-group-add-btn").addEventListener("click",S=>{S.stopPropagation(),$e(e,t,o,n)}),a.querySelector(".todo-group-header")?.addEventListener("click",S=>{S.target.closest(".todo-group-add-btn")||Ye(e)})}let r=a.querySelector(".todo-group-items-inner");if(!r||r.querySelector(".todo-add-input"))return;r.insertAdjacentHTML("afterbegin",`
    ...
    `);let i=r.querySelector(".todo-text-input"),c=r.querySelector(".todo-add-confirm-btn");i.focus();let l=async()=>{let u=i.value.trim();if(!u){$("\u8BF7\u8F93\u5165 Todo \u5185\u5BB9");return}await G(u,{groupId:e,groupTitle:t,groupUrl:o||"",isCustom:n||!1})&&(i.value="",Y())};c.addEventListener("click",l),i.addEventListener("keydown",u=>{u.key==="Enter"&&l(),u.key==="Escape"&&r.querySelector(".todo-add-input")?.remove()})}function Y(){let e=document.getElementById("todoSidebarBody");if(!e)return;if((z?L:L.filter(s=>!s.done)).length===0){e.innerHTML='<div class="todo-empty">\u6682\u65E0 Todo</div>';return}let o=Jt(),n="";for(let s of o){let a=z?s.todos:s.todos.filter(p=>!p.done);if(a.length===0&&!z)continue;let r=s.todos.filter(p=>!p.done).length,d=s.todos.length,i=je(s.groupId),l=s.isCustom?"":`
        ...
        `:"";n+=`
            <div class="todo-group ${i?"collapsed":""}" data-group-id="${M(s.groupId)}">
                <div class="todo-group-header">
                    <span class="todo-group-toggle">\u25BC</span>
        ...
        `}e.innerHTML=n,e.querySelectorAll(".todo-group").forEach(s=>{let a=s.dataset.groupId,r=o.find(l=>l.groupId===a);if(!r)return;s.querySelector(".todo-group-add-btn")?.addEventListener("click",l=>{l.stopPropagation(),$e(a,r.groupTitle,r.groupUrl,r.isCustom)}),s.querySelector(".todo-group-summary-btn")?.addEventListener("click",l=>{l.stopPropagation(),eo(r.groupId,r.groupTitle,r.groupUrl)}),s.querySelector(".todo-group-header")?.addEventListener("click",l=>{l.target.closest(".todo-group-add-btn")||l.target.closest(".todo-group-summary-btn")||Ye(a)}),je(a)&&s.classList.add("collapsed")}),et(e)}function eo(e,t,o){window.openSummaryModal&&window.openSummaryModal(e,t,o,"","")}var Ke="todo_collapsed_groups";function ce(){try{let e=localStorage.getItem(Ke);return e?JSON.parse(e):{}}catch{return{}}}function _e(e){try{localStorage.setItem(Ke,JSON.stringify(e))}catch{}}function je(e){return ce()[e]!==!1}function Ye(e){let t=ce(),o=t[e]!==!1;t[e]=!o,_e(t);let n=document.querySelector(`.todo-group[data-group-id="${e}"]`);n&&n.classList.toggle("collapsed",!o)}function Ze(e){return`
...
`),n=[],s=!1,a=[],r=!1,d=[];for(let i=0;i<o.length;i++){let c=o[i],l=c.trim(),u=/^\|(.+)\|$/.test(l),p=/^\|[\s\-:|]+\|$/.test(l),f=l.match(/^[-*]\s+(.+)$/),h=l.match(/^\d+\.\s+(.+)$/),S=f||h;if(u){if(r&&d.length>0&&(n.push("<ul>"+d.join("")+"</ul>"),d=[],r=!1),s||(s=!0,a=[]),!p){let B=l.slice(1,-1).split("|").map(k=>k.trim()),A=a.length===0?"th":"td",b="<tr>"+B.map(k=>`<${A}>${k}</${A}>`).join("")+"</tr>";a.push(b)}continue}else s&&a.length>0&&(n.push("<table>"+a.join("")+"</table>"),a=[],s=!1);if(S){let B=f?f[1]:h[1];r=!0,d.push("<li>"+B+"</li>");continue}else r&&d.length>0&&(n.push("<ul>"+d.join("")+"</ul>"),d=[],r=!1);n.push(c)}return s&&a.length>0&&n.push("<table>"+a.join("")+"</table>"),r&&d.length>0&&n.push("<ul>"+d.join("")+"</ul>"),t=n.join(`
`),t=t.split(/\n{2,}/).map(i=>(i=i.trim(),i?/^<(h[1-6]|ul|ol|table|pre|blockquote|hr)/.test(i)||/<\/(h[1-6]|ul|ol|table|pre|blockquote)>$/.test(i)?i:"<p>"+i.replace(/\n/g,"<br>")+"</p>":"")).join(`
`),t=t.replace(/<p>\s*<\/p>/g,""),t=t.replace(/<p><hr><\/p>/g,"<hr>"),t=t.replace(/<p>(<table>)/g,"$1"),t=t.replace(/(<\/table>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/<p>(<blockquote>)/g,"$1"),t=t.replace(/(<\/blockquote>)<\/p>/g,"$1"),t=t.replace(/(<h[1-3]>(?:✅\s*|📋\s*)?行动清单\s*<\/h[1-3]>)/gi,'<div class="action-list-header">$1<button class="action-list-add-btn" onclick="addActionListToTodo()">+ Todo</button></div>'),t}function it(){if(document.getElementById("summaryModal"))return;document.body.insertAdjacentHTML("beforeend",`
    ...
    `)}async function He(e,t,o,n,s){if(!T.getUser()){F();return}it();let r=document.getElementById("summaryModal"),d=document.getElementById("summaryModalTitle"),i=document.getElementById("summaryModalBody"),c=document.getElementById("summaryModalFooter");if(y=e,I=t,W=o,ot=n,nt=s,ge=!0,window._currentSummaryNewsId=e,window._currentSummaryNewsTitle=t,window._currentSummaryNewsUrl=o,tt(),d){let l=t&&t.length>50?t.substring(0,50)+"...":t||"AI \u603B\u7ED3";d.textContent=`\u2728 ${l}`}r.classList.add("open"),document.body.style.overflow="hidden",i.innerHTML=`
    ...
    `,c.style.display="none",_(),Z=setTimeout(()=>{console.log("[Summary] 5s timeout, starting countdown");let l=document.getElementById("summarySlowHint"),u=document.getElementById("summaryCountdownText");l&&(l.style.display="block"),q=5;let p=()=>{u&&(u.textContent=`\u52A0\u8F7D\u8F83\u6162\uFF0C${q} \u79D2\u540E\u4E3A\u60A8\u6253\u5F00\u539F\u6587...`)};p(),te=setInterval(()=>{q--,q>0?p():ne()},1e3),oe=setTimeout(()=>{console.log("[Summary] 10s timeout, showing click hint"),ne();let f=document.getElementById("summarySlowHint");f&&(f.innerHTML='\u52A0\u8F7D\u8F83\u6162\uFF0C\u8BF7 <a href="'+o+'" target="_blank" rel="noopener noreferrer" style="color: #3b82f6; text-decoration: underline;">\u70B9\u51FB\u9605\u8BFB\u539F\u6587</a>')},st-ve)},ve),ee=setTimeout(()=>{rt(o,n,s),_();let l=document.getElementById("summaryModal");l&&(l.classList.remove("open"),document.body.style.overflow=""),ge=!1,y=null,o&&window.open(o,"_blank","noopener,noreferrer")},at);try{let l=await fetch(`/api/summary/failures/check?url=${encodeURIComponent(o)}`);if(l.ok){let b=await l.json();if(console.log("[Summary] Check result:",b),b.summarizable)b.warning&&console.log("[Summary] Warning:",b.warning);else{console.log("[Summary] URL blocked, showing blocked UI:",o),_();let k=!Me()&&io(),se=k?lo():null;!Me()&&!k?i.innerHTML=`
                    ...
                    `,c.style.display="none";return}}let u=await fetch("/api/summary/stream",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:o,title:t,news_id:e,source_id:n,source_name:s})});if(!u.ok){let b=await u.json();throw new Error(b.detail||"\u751F\u6210\u5931\u8D25")}let p=u.body.getReader(),f=new TextDecoder,h="",S="other",B="\u5176\u4ED6",D=!1,A=null;for(;;){let{done:b,value:k}=await p.read();if(b)break;let g=f.decode(k,{stream:!0}).split(`
`);for(let Q of g)if(Q.startsWith("data: "))try{let m=JSON.parse(Q.slice(6));switch(m.type){case"status":let ae=document.getElementById("summaryStatusText");ae&&(ae.textContent=m.message);break;case"type":S=m.article_type,B=m.article_type_name,window._currentTypeConfidence=m.confidence||0;break;case"chunk":D||(D=!0,_(),i.innerHTML=`
                                    <div class="summary-content summary-streaming" id="summaryStreamContent">
                                        <div class="summary-cursor"></div>
                                    </div>
                                `),h+=m.content;let N=document.getElementById("summaryStreamContent");if(N){let v=h;v=v.replace(/\[TAGS_?START\][\s\S]*$/gi,""),N.innerHTML=O(v)+'<span class="summary-cursor">\u258C</span>',N.scrollTop=N.scrollHeight}break;case"cached":_(),h=m.summary,S=m.article_type,B=m.article_type_name,A=m.token_usage||null;let x=m.feedback||null,Lt=m.token_balance!==void 0?{token_balance:m.token_balance,tokens_used:m.tokens_used,default_tokens:1e5}:null,_t=Ae(h);if(i.innerHTML=`
                                <div class="summary-content">
                                    ${O(_t)}
                                </div>
                            `,fe(o,S,B,!0,A,x,Lt),ye(e,!0),m.tags&&window.ArticleTags){console.log("[Summary] Applying cached tags for newsId:",e,"tags:",m.tags);let v=document.querySelector(`.news-item[data-news-id="${e}"]`);v||(v=document.querySelector(`.news-item[data-url="${o}"]`)),v&&(console.log("[Summary] Found news item for cached, applying tags"),window.ArticleTags.applyTags(v,m.tags),v.dataset.tagsLoaded="true")}return;case"done":A=m.token_usage||null;let It=m.token_balance!==void 0?{token_balance:m.token_balance,tokens_used:m.tokens_used,default_tokens:1e5}:null,be=document.getElementById("summaryStreamContent");if(be){be.classList.remove("summary-streaming");let v=Ae(h);be.innerHTML=O(v)}let Ct=window._currentTypeConfidence||0;if(fe(o,S,B,!1,A,null,It,Ct),ye(e,!0),m.tags&&window.ArticleTags){console.log("[Summary] Applying tags for newsId:",e,"tags:",m.tags);let v=document.querySelector(`.news-item[data-news-id="${e}"]`);v||(v=document.querySelector(`.news-item[data-url="${o}"]`)),v?(console.log("[Summary] Found news item, applying tags"),window.ArticleTags.applyTags(v,m.tags),v.dataset.tagsLoaded="true"):console.log("[Summary] News item not found in DOM")}break;case"short_content":_(),i.innerHTML=`
                                <div class="summary-short-content">
                                    <div class="short-content-icon">\u{1F4C4}</div>
                                    <div class="short-content-message">${m.message}</div>
                                    <div class="short-content-length">\u6587\u7AE0\u957F\u5EA6\uFF1A${m.content_length} \u5B57</div>
                                    ${m.preview?`<div class="short-content-preview">${m.preview}</div>`:""}
                            ...
                            `,c.style.display="none";return;case"error":throw new Error(m.message)}}catch(m){if(m.message&&!m.message.includes("JSON"))throw m}}if(D&&h&&!document.querySelector('.summary-modal-footer[style*="flex"]')){console.log("[Summary] Stream ended without done event, showing fallback footer");let b=document.getElementById("summaryStreamContent");if(b){b.classList.remove("summary-streaming");let k=Ae(h);b.innerHTML=O(k)}fe(o,S,B,!1,A,null,null,0),ye(e,!0)}}catch(l){if(console.error("[Summary] Error:",l),_(),l.message&&(l.message.includes("\u8BBF\u95EE\u9650\u5236")||l.message.includes("\u65E0\u6CD5\u83B7\u53D6")||l.message.includes("\u65E0\u6CD5\u8BBF\u95EE")||l.message.includes("\u8BF7\u6C42\u5931\u8D25")))i.innerHTML=`
            ...
            `;else{Pe();return}}}function fe(e,t,o,n,s,a=null,r=null,d=null){let i=document.getElementById("summaryModalFooter"),c=mo[t]||"\u{1F4DD}",l="",u=s?.total_tokens||0;u>0&&(l=`<span class="summary-token-tag" title="\u672C\u6B21\u6D88\u8017">\u{1FA99} ${po(u)}</span>`);let p=a==="up"?"active":"",f=a==="down"?"active":"";i.innerHTML=`
        <div class="summary-footer-left">
            ${l}
            <span class="summary-type-tag">${c} ${o}</span>
    ...
    `,i.style.display="none",_(),Z=setTimeout(()=>{console.log("[Summary Force] 5s timeout, starting countdown");let c=document.getElementById("summarySlowHint"),l=document.getElementById("summaryCountdownText");c&&(c.style.display="block"),q=5;let u=()=>{l&&(l.textContent=`\u52A0\u8F7D\u8F83\u6162\uFF0C${q} \u79D2\u540E\u4E3A\u60A8\u6253\u5F00\u539F\u6587...`)};u(),te=setInterval(()=>{q--,q>0?u():ne()},1e3),oe=setTimeout(()=>{console.log("[Summary Force] 10s timeout, showing click hint"),ne();let p=document.getElementById("summarySlowHint");p&&(p.innerHTML='\u52A0\u8F7D\u8F83\u6162\uFF0C\u8BF7 <a href="'+o+'" target="_blank" rel="noopener noreferrer" style="color: #3b82f6; text-decoration: underline;">\u70B9\u51FB\u9605\u8BFB\u539F\u6587</a>')},st-ve)},ve),ee=setTimeout(()=>{rt(o,n,s),_();let c=document.getElementById("summaryModal");c&&(c.classList.remove("open"),document.body.style.overflow=""),ge=!1,y=null,o&&window.open(o,"_blank","noopener,noreferrer")},at);try{let c=await fetch("/api/summary/stream?force=1",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:o,title:t,news_id:e,source_id:n,source_name:s})});if(!c.ok){let D=await c.json();throw new Error(D.detail||"\u751F\u6210\u5931\u8D25")}let l=c.body.getReader(),u=new TextDecoder,p="",f="other",h="\u5176\u4ED6",S=!1,B=null;for(;;){let{done:D,value:A}=await l.read();if(D)break;let k=u.decode(A,{stream:!0}).split(`
`);for(let se of k)if(se.startsWith("data: "))try{let g=JSON.parse(se.slice(6));switch(g.type){case"status":let Q=document.getElementById("summaryStatusText");Q&&(Q.textContent=g.message);break;case"type":f=g.article_type,h=g.article_type_name;break;case"chunk":S||(S=!0,_(),d.innerHTML=`
                                    <div class="summary-content summary-streaming" id="summaryStreamContent">
                                        <div class="summary-cursor"></div>
                                    </div>
                                `),p+=g.content;let m=document.getElementById("summaryStreamContent");if(m){let x=p;x=x.replace(/\[TAGS_?START\][\s\S]*$/gi,""),m.innerHTML=O(x)+'<span class="summary-cursor">\u258C</span>',m.scrollTop=m.scrollHeight}break;case"done":_(),B=g.token_usage||null;let ae=g.token_balance!==void 0?{token_balance:g.token_balance,tokens_used:g.tokens_used,default_tokens:1e5}:null,N=document.getElementById("summaryStreamContent");if(N&&(N.classList.remove("summary-streaming"),N.innerHTML=O(p)),fe(o,f,h,!1,B,null,ae),ye(e,!0),g.tags&&window.ArticleTags){let x=document.querySelector(`.news-item[data-news-id="${e}"]`);x||(x=document.querySelector(`.news-item[data-url="${o}"]`)),x&&(window.ArticleTags.applyTags(x,g.tags),x.dataset.tagsLoaded="true")}break;case"error":throw new Error(g.message)}}catch(g){if(g.message&&!g.message.includes("JSON"))throw g}}}catch(c){if(console.error("[Summary] Force error:",c),_(),c.message&&(c.message.includes("\u8BBF\u95EE\u9650\u5236")||c.message.includes("\u65E0\u6CD5\u83B7\u53D6")||c.message.includes("\u65E0\u6CD5\u8BBF\u95EE")||c.message.includes("\u8BF7\u6C42\u5931\u8D25")))d.innerHTML=`
                <div class="summary-access-error">
                    <div class="summary-access-error-icon">\u{1F512}</div>
                    <div class="summary-access-error-title">\u6682\u65F6\u65E0\u6CD5\u83B7\u53D6\u5185\u5BB9</div>
                    <div class="summary-access-error-text">\u8BE5\u7F51\u7AD9\u8BBE\u7F6E\u4E86\u8BBF\u95EE\u4FDD\u62A4\uFF0C\u5EFA\u8BAE\u76F4\u63A5\u9605\u8BFB\u539F\u6587</div>
                ...
                <div class="favorite-item" data-news-id="${n.news_id}">
                    ...
                    <div class="favorite-item-meta">
                        ...
                        <div class="favorite-item-actions">
                            ...
                            <button class="favorite-draft-btn" 
                                    style="display:${window._publisherUserInfo?"inline-flex":"none"};"
                                    onclick="handleToDraftClick(event, '${n.news_id}', '${(n.title||"").replace(/'/g,"\\'")}', '${(n.url||"").replace(/'/g,"\\'")}', '${n.source_id||""}', '${(n.source_name||"").replace(/'/g,"\\'")}')" 
                                    title="\u8F6C\u4E3A\u8349\u7A3F">
                                \u270F\uFE0F
                            </button>
    ...
    `;t.innerHTML=o}function ct(){let e=document.getElementById("favoritesPanelBody");if(!e)return;let t=he();t.length>0?e.innerHTML=`
        ...
        `;return}Io(o.favorites)}function Co(){if(!T.getUser()){F();return}let t=document.getElementById("favoritesPanel"),o=document.getElementById("favoritesOverlay");t&&(o||(o=document.createElement("div"),o.id="favoritesOverlay",o.className="favorites-overlay",o.onclick=St,document.body.appendChild(o)),we=!we,we?(t.classList.add("open"),o.classList.add("open"),Tt()):(t.classList.remove("open"),o.classList.remove("open")))}function St(){let e=document.getElementById("favoritesPanel"),t=document.getElementById("favoritesOverlay");we=!1,e&&e.classList.remove("open"),t&&t.classList.remove("open")}async function Bo(e){if((await vt(e)).ok){let o=document.querySelector(`.favorite-item[data-news-id="${e}"]`);o&&o.remove();let n=document.querySelector(`.news-favorite-btn[data-news-id="${e}"]`);n&&(n.classList.remove("favorited"),n.textContent="\u2606");let s=document.querySelector(".favorites-list");s&&s.children.length===0&&Tt()}}function $o(e,t,o,n,s,a){if(e.preventDefault(),e.stopPropagation(),!T.getUser()){F();return}let d=e.currentTarget;ht({news_id:t,title:o,url:n,source_id:s||"",source_name:a||""},d)}function xo(){try{let e=localStorage.getItem(yt);if(e){let t=parseInt(e,10);if(t>=qe&&t<=Oe)return t}}catch{}return Eo}function ut(e){try{localStorage.setItem(yt,String(e)),re.saveSidebarWidths({favorites_width:e})}catch{}}function Mo(e){let t=document.getElementById("favoritesPanel");t&&(t.style.width=e+"px")}function mt(){let e=document.getElementById("favoritesPanel"),t=document.getElementById("favoritesResizeHandle");if(!e||!t)return;let o=xo();Mo(o);let n=0,s=0;function a(u){u.preventDefault(),R=!0,n=u.clientX,s=e.offsetWidth,e.classList.add("resizing"),t.classList.add("active"),document.addEventListener("mousemove",r),document.addEventListener("mouseup",d)}function r(u){if(!R)return;let p=n-u.clientX,f=s+p;f=Math.max(qe,Math.min(Oe,f)),e.style.width=f+"px"}function d(){R&&(R=!1,e.classList.remove("resizing"),t.classList.remove("active"),document.removeEventListener("mousemove",r),document.removeEventListener("mouseup",d),ut(e.offsetWidth))}function i(u){u.touches.length===1&&(u.preventDefault(),R=!0,n=u.touches[0].clientX,s=e.offsetWidth,e.classList.add("resizing"),t.classList.add("active"),document.addEventListener("touchmove",c,{passive:!1}),document.addEventListener("touchend",l))}function c(u){if(!R||u.touches.length!==1)return;u.preventDefault();let p=n-u.touches[0].clientX,f=s+p;f=Math.max(qe,Math.min(Oe,f)),e.style.width=f+"px"}function l(){R&&(R=!1,e.classList.remove("resizing"),t.classList.remove("active"),document.removeEventListener("touchmove",c),document.removeEventListener("touchend",l),ut(e.offsetWidth))}t.addEventListener("mousedown",a),t.addEventListener("touchstart",i,{passive:!1})}function pt(){document.addEventListener("click",e=>{let t=e.target.closest(".news-favorite-btn");if(!t)return;if(e.preventDefault(),e.stopPropagation(),!T.getUser()){F();return}let n=t.closest(".news-item");if(!n)return;let s=n.dataset.id||n.dataset.newsId,a=n.dataset.url,r=n.querySelector(".news-title"),d=r?r.textContent.trim():"",i=n.closest(".platform-card"),c=i?i.dataset.platform:"",l=i?i.querySelector(".platform-name"):null,u=l?l.textContent.replace("\u{1F4F1}","").trim():"";ht({news_id:s,title:d,url:a,source_id:c,source_name:u},t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{mt(),pt()}):(mt(),pt());async function kt(e){let t=document.getElementById(`summary-${e}`),o=document.querySelector(`.favorite-item[data-news-id="${e}"] .favorite-summary-btn`);if(!(!t||!o)){if(o.classList.contains("has-summary")){Et(e);return}o.disabled=!0,o.textContent="\u23F3",o.title="\u751F\u6210\u4E2D...",t.style.display="block",t.innerHTML=`
        <div class="summary-loading">
            <div class="summary-loading-spinner"></div>
    ...
    `;try{let n=await fetch(`/api/user/favorites/${encodeURIComponent(e)}/summary`,{method:"POST"}),s=await n.json();if(!n.ok)throw new Error(s.detail||"\u751F\u6210\u5931\u8D25");if(s.ok&&s.summary){if(o.classList.add("has-summary"),o.textContent="\u{1F4C4}",o.title="\u67E5\u770B\u603B\u7ED3",t.innerHTML=`
        ...
        `,o.textContent="\u{1F4DD}",o.title="AI \u603B\u7ED3"}finally{o.disabled=!1}}}function Et(e){let t=document.getElementById(`summary-${e}`);if(!t)return;let o=t.style.display!=="none";t.style.display=o?"none":"block";let n=t.querySelector(".summary-toggle-btn");n&&(n.textContent=o?"\u5C55\u5F00":"\u6536\u8D77")}async function Ao(e){let t=document.getElementById(`summary-${e}`),o=document.querySelector(`.favorite-item[data-news-id="${e}"] .favorite-summary-btn`);if(t){try{await fetch(`/api/user/favorites/${encodeURIComponent(e)}/summary`,{method:"DELETE"})}catch(n){console.error("[Favorites] Delete summary error:",n)}if(o&&(o.classList.remove("has-summary"),o.textContent="\u{1F4DD}"),C){let n=C.find(s=>s.news_id===e);n&&(n.summary=null,n.summary_at=null)}await kt(e)}}window.toggleFavoritesPanel=Co;window.closeFavoritesPanel=St;window.removeFavoriteFromPanel=Bo;window.handleFavoriteClick=$o;window.isFavorited=wt;window.handleFavoriteSummaryClick=kt;window.toggleSummaryDisplay=Et;window.regenerateSummary=Ao;async function Fo(e,t,o,n,s,a){e.preventDefault(),e.stopPropagation();let r=e.currentTarget,d=r.textContent;try{if(r.disabled=!0,r.textContent="\u23F3",n){let i=await fetch("/api/publisher/drafts",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({title:o||"",digest:"",html_content:"",import_type:"favorite",import_source_id:t||"",import_source_url:n||""})}),c=await i.json();if(!i.ok)throw new Error(c.detail||c.message||"\u521B\u5EFA\u8349\u7A3F\u5931\u8D25");if(c.ok&&c.data&&c.data.id)window.location.href=`/write/${c.data.id}?import=url&url=${encodeURIComponent(n)}`;else throw new Error("\u521B\u5EFA\u8349\u7A3F\u5931\u8D25")}else{let i=await fetch("/api/publisher/drafts",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({title:o||"",digest:"",html_content:"",import_type:"favorite",import_source_id:t||""})}),c=await i.json();if(!i.ok)throw new Error(c.detail||c.message||"\u521B\u5EFA\u8349\u7A3F\u5931\u8D25");if(c.ok&&c.data&&c.data.id)window.location.href=`/write/${c.data.id}`;else throw new Error("\u521B\u5EFA\u8349\u7A3F\u5931\u8D25")}}catch(i){console.error("[Favorites] ToDraft error:",i),alert(i.message||"\u521B\u5EFA\u8349\u7A3F\u5931\u8D25"),r.disabled=!1,r.textContent=d}}window.handleToDraftClick=Fo;export{F as a,Ie as b,ao as c,_o as d,vt as e,wt as f,ht as g,Co as h,St as i,$o as j};
