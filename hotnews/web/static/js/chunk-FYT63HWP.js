import{a as T,b as Z}from"./chunk-ICSVECP2.js";var ge="",ee=0,F=null,Q=null,N=null,A=null,Me=300;function vt(){return navigator.userAgent.toLowerCase().indexOf("micromessenger")!==-1}function x(){if(vt()){window.location.href="/api/auth/oauth/wechat-mp";return}let e=document.getElementById("loginModal");e&&(e.style.display="flex",we(),V(1),ve())}function te(){let e=document.getElementById("loginModal");e&&(e.style.display="none"),F&&(clearInterval(F),F=null),oe(),he(),we();let t=document.getElementById("login-email"),o=document.getElementById("login-code");t&&(t.value=""),o&&(o.value="")}async function ve(){let e=document.getElementById("login-qr-loading"),t=document.getElementById("login-qr-image"),o=document.getElementById("login-qr-expired"),n=document.getElementById("login-qr-countdown");e&&(e.style.display="flex"),t&&(t.style.display="none"),o&&(o.style.display="none"),n&&(n.style.display="none"),oe();try{let r=await(await fetch("/api/auth/wechat-qr/create",{method:"POST",headers:{"Content-Type":"application/json"}})).json();r.ok&&r.qr_url?(Q=r.session_id,Me=r.expire_seconds||300,t&&(t.src=r.qr_url,t.onload=()=>{e&&(e.style.display="none"),t.style.display="block"},t.onerror=()=>{e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent="\u52A0\u8F7D\u5931\u8D25")}),ht(Me),bt()):(e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent=r.message||"\u52A0\u8F7D\u5931\u8D25"))}catch(s){console.error("Failed to load WeChat QR:",s),e&&(e.style.display="none"),o&&(o.style.display="flex",o.querySelector("span").textContent="\u7F51\u7EDC\u9519\u8BEF")}}function wt(){ve()}function ht(e){let t=document.getElementById("login-qr-countdown"),o=document.getElementById("login-qr-countdown-text");if(!t||!o)return;let n=e;t.style.display="block";let s=()=>{let r=Math.floor(n/60),a=n%60;o.textContent=`${r}:${a.toString().padStart(2,"0")}`,n<60?t.classList.add("warning"):t.classList.remove("warning")};s(),A=setInterval(()=>{n--,n<=0?(clearInterval(A),A=null,Fe()):s()},1e3)}function Fe(){let e=document.getElementById("login-qr-image"),t=document.getElementById("login-qr-expired"),o=document.getElementById("login-qr-countdown");e&&(e.style.display="none"),t&&(t.style.display="flex",t.querySelector("span").textContent="\u4E8C\u7EF4\u7801\u5DF2\u8FC7\u671F"),o&&(o.style.display="none"),oe()}function bt(){if(!Q)return;let e=async()=>{let t=Q;if(t)try{let n=await(await fetch(`/api/auth/wechat-qr/status?session_id=${encodeURIComponent(t)}`)).json();if(n.status==="confirmed"&&n.session_token){N&&(clearInterval(N),N=null),A&&(clearInterval(A),A=null),E("\u767B\u5F55\u6210\u529F","success");try{await fetch(`/api/auth/wechat-qr/confirm-cookie?session_id=${encodeURIComponent(t)}`,{method:"POST",headers:{"Content-Type":"application/json"}})}catch(s){console.error("Failed to set cookie:",s)}Q=null,setTimeout(()=>{te(),window.location.reload()},500);return}else if(n.status==="scanned")E("\u5DF2\u626B\u7801\uFF0C\u8BF7\u5728\u624B\u673A\u4E0A\u786E\u8BA4","success");else if(n.status==="expired"){Fe();return}}catch(o){console.error("Polling error:",o)}};N=setInterval(e,2e3),e()}function oe(){N&&(clearInterval(N),N=null),A&&(clearInterval(A),A=null),Q=null}function Tt(){let e=document.getElementById("login-main"),t=document.getElementById("login-email-form");e&&(e.style.display="none"),t&&(t.style.display="block"),oe(),setTimeout(()=>{let o=document.getElementById("login-email");o&&o.focus()},100)}function we(){let e=document.getElementById("login-main"),t=document.getElementById("login-email-form");e&&(e.style.display="block"),t&&(t.style.display="none"),V(1),he(),ve()}function St(e){e.target.id==="loginModal"&&te()}function E(e,t){let o=document.getElementById("login-message");o&&(o.textContent=e,o.className="login-message "+t)}function he(){let e=document.getElementById("login-message");e&&(e.className="login-message")}function V(e){document.querySelectorAll(".login-step").forEach(o=>o.classList.remove("active"));let t=document.getElementById("login-step-"+e);t&&t.classList.add("active"),document.querySelectorAll(".login-step-dot").forEach((o,n)=>{o.classList.toggle("active",n<e)}),he()}function Et(){V(1),F&&(clearInterval(F),F=null)}function Ae(){ee=60;let e=document.getElementById("login-resend-btn"),t=document.getElementById("login-resend-text");e&&(e.disabled=!0),F=setInterval(()=>{ee--,ee<=0?(clearInterval(F),F=null,e&&(e.disabled=!1),t&&(t.textContent="\u91CD\u65B0\u53D1\u9001")):t&&(t.textContent=ee+"\u79D2\u540E\u91CD\u53D1")},1e3)}async function kt(e){e.preventDefault();let t=document.getElementById("login-send-btn"),o=document.getElementById("login-email").value.trim();if(!o){E("\u8BF7\u8F93\u5165\u90AE\u7BB1","error");return}t&&(t.disabled=!0,t.textContent="\u53D1\u9001\u4E2D...");try{let n=await fetch("/api/auth/send-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o})}),s=await n.json();if(n.ok){ge=o;let r=document.getElementById("login-display-email");r&&(r.textContent=o),V(2);let a=document.getElementById("login-code");a&&a.focus(),Ae()}else{let r=typeof s.detail=="string"?s.detail:s.detail?.[0]?.msg||s.message||"\u53D1\u9001\u5931\u8D25";E(r,"error")}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error")}t&&(t.disabled=!1,t.textContent="\u83B7\u53D6\u9A8C\u8BC1\u7801")}async function Lt(){let e=document.getElementById("login-resend-btn");e&&(e.disabled=!0);try{let t=await fetch("/api/auth/send-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ge})}),o=await t.json();if(t.ok)E("\u9A8C\u8BC1\u7801\u5DF2\u91CD\u65B0\u53D1\u9001","success"),Ae();else{let n=typeof o.detail=="string"?o.detail:o.detail?.[0]?.msg||o.message||"\u53D1\u9001\u5931\u8D25";E(n,"error"),e&&(e.disabled=!1)}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error"),e&&(e.disabled=!1)}}async function It(e){e.preventDefault();let t=document.getElementById("login-verify-btn"),o=document.getElementById("login-code").value.trim();if(!o||o.length!==6){E("\u8BF7\u8F93\u51656\u4F4D\u9A8C\u8BC1\u7801","error");return}t&&(t.disabled=!0,t.textContent="\u767B\u5F55\u4E2D...");try{let n=await fetch("/api/auth/verify-code",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ge,code:o})}),s=await n.json();if(n.ok)E("\u767B\u5F55\u6210\u529F","success"),setTimeout(()=>{te(),window.location.reload()},500);else{let r=typeof s.detail=="string"?s.detail:s.detail?.[0]?.msg||s.message||"\u9A8C\u8BC1\u5931\u8D25";E(r,"error")}}catch{E("\u7F51\u7EDC\u9519\u8BEF\uFF0C\u8BF7\u91CD\u8BD5","error")}t&&(t.disabled=!1,t.textContent="\u767B\u5F55")}function xe(){let e=document.getElementById("login-code");e&&e.addEventListener("input",function(t){this.value=this.value.replace(/[^0-9]/g,"").slice(0,6)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",xe):xe();window.openLoginModal=x;window.closeLoginModal=te;window.closeLoginModalOnOverlay=St;window.loginSendCode=kt;window.loginVerifyCode=It;window.loginResendCode=Lt;window.loginGoBack=Et;window.loginGoToStep=V;window.loginShowMessage=E;window.loginShowEmailForm=Tt;window.loginHideEmailForm=we;window.refreshWechatQR=wt;var k=[],W=!1,He=!1,Oe=!1,Ne=null;function R(){return T.getUser()?!0:(x(),!1)}async function _t(e=null){let t="/api/user/todos";e&&(t+=`?group_id=${encodeURIComponent(e)}`);let o=await fetch(t);if(!o.ok){if(o.status===401)return[];throw new Error("\u83B7\u53D6 Todo \u5931\u8D25")}return(await o.json()).todos||[]}async function Bt(e){let t=await fetch("/api/user/todos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u6DFB\u52A0\u5931\u8D25")}return await t.json()}async function Ct(e,t){let o=await fetch(`/api/user/todos/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!o.ok){let n=await o.json();throw new Error(n.detail||"\u66F4\u65B0\u5931\u8D25")}return await o.json()}async function $t(e){let t=await fetch(`/api/user/todos/${e}`,{method:"DELETE"});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u5220\u9664\u5931\u8D25")}return await t.json()}async function Mt(e){let t=await fetch("/api/user/todos/batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({todos:e})});if(!t.ok){let o=await t.json();throw new Error(o.detail||"\u6279\u91CF\u6DFB\u52A0\u5931\u8D25")}return await t.json()}async function Se(){if(!R())return[];try{return k=await _t(),X(),k}catch(e){return console.error("[Todo] Load error:",e),[]}}async function z(e,t){if(!R())return null;try{let o=await Bt({text:e,group_id:t.groupId,group_title:t.groupTitle,group_url:t.groupUrl||"",is_custom_group:t.isCustom||!1});if(o.ok&&o.todo)return k.unshift(o.todo),X(),C("\u5DF2\u6DFB\u52A0\u5230 Todo"),o.todo}catch(o){o.message.includes("\u5DF2\u5B58\u5728")?C("\u8BE5 Todo \u5DF2\u5B58\u5728"):C("\u6DFB\u52A0\u5931\u8D25: "+o.message),console.error("[Todo] Add error:",o)}return null}async function xt(e){if(!R())return;let t=k.find(n=>n.id===e);if(!t)return;let o=!t.done;try{await Ct(e,{done:o}),t.done=o,K(),ae(),X()}catch(n){console.error("[Todo] Toggle error:",n),C("\u66F4\u65B0\u5931\u8D25")}}async function Ft(e){if(R())try{await $t(e),k=k.filter(t=>t.id!==e),K(),ae(),X(),C("\u5DF2\u5220\u9664")}catch(t){console.error("[Todo] Delete error:",t),C("\u5220\u9664\u5931\u8D25")}}async function Ee(e,t){if(!R())return null;let o=e.map(n=>({text:n,group_id:t.groupId,group_title:t.groupTitle,group_url:t.groupUrl||"",is_custom_group:t.isCustom||!1}));try{let n=await Mt(o);if(n.ok){n.added&&n.added.length>0&&(k=[...n.added,...k],X());let s=n.skipped_count>0?`\u5DF2\u6DFB\u52A0 ${n.added_count} \u9879\uFF0C${n.skipped_count} \u9879\u5DF2\u5B58\u5728`:`\u5DF2\u6DFB\u52A0 ${n.added_count} \u9879\u5230 Todo`;return C(s),n}}catch(n){console.error("[Todo] Batch add error:",n),C("\u6279\u91CF\u6DFB\u52A0\u5931\u8D25")}return null}function ke(e){return k.filter(t=>t.source.groupId===e)}function At(){return k.filter(e=>!e.done).length}function qt(){let e={};for(let t of k){let o=t.source.groupId;e[o]||(e[o]={groupId:o,groupTitle:t.source.groupTitle,groupUrl:t.source.groupUrl,isCustom:t.source.isCustom,todos:[]}),e[o].todos.push(t)}return Object.values(e)}function $(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function C(e){if(window.showToast)window.showToast(e);else{let t=document.createElement("div");t.className="todo-toast",t.textContent=e,document.body.appendChild(t),setTimeout(()=>t.classList.add("show"),10),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>t.remove(),300)},2e3)}}function X(){let e=document.getElementById("todoBadge");if(!e)return;let t=At();t>0?(e.textContent=t>99?"99+":t,e.classList.add("show")):e.classList.remove("show")}var Re="todo_sidebar_width",Pt=320,Dt=800;function Ht(){if(document.getElementById("todoSidebar"))return;let e=document.createElement("div");e.id="todoSidebarBackdrop",e.className="todo-sidebar-backdrop",document.body.appendChild(e),document.body.insertAdjacentHTML("beforeend",`
    ...
    `);let o=localStorage.getItem(Re);if(o){let i=document.getElementById("todoSidebar");i.style.width=o+"px"}let s=document.getElementById("todoSidebar").querySelector(".todo-close-btn"),r=document.getElementById("todoFilterBtn"),a=document.getElementById("todoNewGroupBtn");e.addEventListener("click",be),s.addEventListener("click",be),r.addEventListener("click",Nt),a.addEventListener("click",Rt),Ot()}function Ot(){let e=document.getElementById("todoSidebar"),t=document.getElementById("todoResizeHandle");if(!e||!t)return;let o=!1,n=0,s=0;t.addEventListener("mousedown",r=>{o=!0,n=r.clientX,s=e.offsetWidth,e.classList.add("resizing"),t.classList.add("active"),r.preventDefault()}),document.addEventListener("mousemove",r=>{if(!o)return;let a=n-r.clientX,i=s+a;i=Math.max(Pt,Math.min(Dt,i)),e.style.width=i+"px"}),document.addEventListener("mouseup",()=>{o&&(o=!1,e.classList.remove("resizing"),t.classList.remove("active"),localStorage.setItem(Re,e.offsetWidth),Z.saveSidebarWidths({todo_width:e.offsetWidth}))})}function Ue(){if(!R())return;Ht();let e=document.getElementById("todoSidebar"),t=document.getElementById("todoSidebarBackdrop");e.classList.add("open"),t.classList.add("show"),He=!0,Se().then(()=>K())}function be(){let e=document.getElementById("todoSidebar"),t=document.getElementById("todoSidebarBackdrop");e&&e.classList.remove("open"),t&&t.classList.remove("show"),He=!1}function Nt(){W=!W;let e=document.getElementById("todoFilterBtn");e&&(e.textContent=W?"\u53EA\u770B\u672A\u5B8C\u6210":"\u663E\u793A\u5168\u90E8"),K()}function Rt(){let e=document.getElementById("todoSidebarBody");if(!e||e.querySelector(".todo-new-group-input"))return;e.insertAdjacentHTML("afterbegin",`
    ...
    `);let o=e.querySelector(".todo-group-name-input"),n=e.querySelector(".todo-group-create-btn"),s=e.querySelector(".todo-group-cancel-btn");o.focus();let r=()=>{let a=o.value.trim();if(!a){C("\u8BF7\u8F93\u5165\u6807\u9898\u540D\u79F0");return}let i=`custom_${Date.now()}`;Le(i,a,"",!0),e.querySelector(".todo-new-group-input")?.remove()};n.addEventListener("click",r),s.addEventListener("click",()=>{e.querySelector(".todo-new-group-input")?.remove()}),o.addEventListener("keydown",a=>{a.key==="Enter"&&r(),a.key==="Escape"&&e.querySelector(".todo-new-group-input")?.remove()})}function Le(e,t,o,n){let s=document.getElementById("todoSidebarBody");if(!s)return;let r=s.querySelector(`.todo-group[data-group-id="${e}"]`);if(r){r.classList.remove("collapsed");let c=ne();c[e]=!1,Te(c)}else{let c=ne();c[e]=!1,Te(c);let f=`
        ...
        `;s.insertAdjacentHTML("afterbegin",f),r=s.querySelector(`.todo-group[data-group-id="${e}"]`),r.querySelector(".todo-group-add-btn").addEventListener("click",S=>{S.stopPropagation(),Le(e,t,o,n)}),r.querySelector(".todo-group-header")?.addEventListener("click",S=>{S.target.closest(".todo-group-add-btn")||We(e)})}let a=r.querySelector(".todo-group-items-inner");if(!a||a.querySelector(".todo-add-input"))return;a.insertAdjacentHTML("afterbegin",`
    ...
    `);let d=a.querySelector(".todo-text-input"),m=a.querySelector(".todo-add-confirm-btn");d.focus();let l=async()=>{let c=d.value.trim();if(!c){C("\u8BF7\u8F93\u5165 Todo \u5185\u5BB9");return}await z(c,{groupId:e,groupTitle:t,groupUrl:o||"",isCustom:n||!1})&&(d.value="",K())};m.addEventListener("click",l),d.addEventListener("keydown",c=>{c.key==="Enter"&&l(),c.key==="Escape"&&a.querySelector(".todo-add-input")?.remove()})}function K(){let e=document.getElementById("todoSidebarBody");if(!e)return;if((W?k:k.filter(s=>!s.done)).length===0){e.innerHTML='<div class="todo-empty">\u6682\u65E0 Todo</div>';return}let o=qt(),n="";for(let s of o){let r=W?s.todos:s.todos.filter(f=>!f.done);if(r.length===0&&!W)continue;let a=s.todos.filter(f=>!f.done).length,i=s.todos.length,d=qe(s.groupId),l=s.isCustom?"":`
        ...
        `:"";n+=`
            <div class="todo-group ${d?"collapsed":""}" data-group-id="${$(s.groupId)}">
                <div class="todo-group-header">
                    <span class="todo-group-toggle">\u25BC</span>
        ...
        `}e.innerHTML=n,e.querySelectorAll(".todo-group").forEach(s=>{let r=s.dataset.groupId,a=o.find(l=>l.groupId===r);if(!a)return;s.querySelector(".todo-group-add-btn")?.addEventListener("click",l=>{l.stopPropagation(),Le(r,a.groupTitle,a.groupUrl,a.isCustom)}),s.querySelector(".todo-group-summary-btn")?.addEventListener("click",l=>{l.stopPropagation(),Ut(a.groupId,a.groupTitle,a.groupUrl)}),s.querySelector(".todo-group-header")?.addEventListener("click",l=>{l.target.closest(".todo-group-add-btn")||l.target.closest(".todo-group-summary-btn")||We(r)}),qe(r)&&s.classList.add("collapsed")}),Ge(e)}function Ut(e,t,o){window.openSummaryModal&&window.openSummaryModal(e,t,o,"","")}var je="todo_collapsed_groups";function ne(){try{let e=localStorage.getItem(je);return e?JSON.parse(e):{}}catch{return{}}}function Te(e){try{localStorage.setItem(je,JSON.stringify(e))}catch{}}function qe(e){return ne()[e]!==!1}function We(e){let t=ne(),o=t[e]!==!1;t[e]=!o,Te(t);let n=document.querySelector(`.todo-group[data-group-id="${e}"]`);n&&n.classList.toggle("collapsed",!o)}function ze(e){return`
    ...
    `}function Ge(e){e.querySelectorAll(".todo-item").forEach(t=>{let o=parseInt(t.dataset.id),n=t.querySelector(".todo-checkbox"),s=t.querySelector(".todo-delete-btn");n?.addEventListener("change",()=>xt(o)),s?.addEventListener("click",r=>{r.stopPropagation(),Ft(o)})})}function jt(){if(document.getElementById("summaryTodoPanel"))return;let e=`
...
`),n=[],s=!1,r=[],a=!1,i=[];for(let d=0;d<o.length;d++){let m=o[d],l=m.trim(),c=/^\|(.+)\|$/.test(l),f=/^\|[\s\-:|]+\|$/.test(l),y=l.match(/^[-*]\s+(.+)$/),h=l.match(/^\d+\.\s+(.+)$/),S=y||h;if(c){if(a&&i.length>0&&(n.push("<ul>"+i.join("")+"</ul>"),i=[],a=!1),s||(s=!0,r=[]),!f){let _=l.slice(1,-1).split("|").map(B=>B.trim()),M=r.length===0?"th":"td",b="<tr>"+_.map(B=>`<${M}>${B}</${M}>`).join("")+"</tr>";r.push(b)}continue}else s&&r.length>0&&(n.push("<table>"+r.join("")+"</table>"),r=[],s=!1);if(S){let _=y?y[1]:h[1];a=!0,i.push("<li>"+_+"</li>");continue}else a&&i.length>0&&(n.push("<ul>"+i.join("")+"</ul>"),i=[],a=!1);n.push(m)}return s&&r.length>0&&n.push("<table>"+r.join("")+"</table>"),a&&i.length>0&&n.push("<ul>"+i.join("")+"</ul>"),t=n.join(`
`),t=t.split(/\n{2,}/).map(d=>(d=d.trim(),d?/^<(h[1-6]|ul|ol|table|pre|blockquote|hr)/.test(d)||/<\/(h[1-6]|ul|ol|table|pre|blockquote)>$/.test(d)?d:"<p>"+d.replace(/\n/g,"<br>")+"</p>":"")).join(`
`),t=t.replace(/<p>\s*<\/p>/g,""),t=t.replace(/<p><hr><\/p>/g,"<hr>"),t=t.replace(/<p>(<table>)/g,"$1"),t=t.replace(/(<\/table>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/<p>(<blockquote>)/g,"$1"),t=t.replace(/(<\/blockquote>)<\/p>/g,"$1"),t=t.replace(/(<h[1-3]>(?:✅\s*|📋\s*)?行动清单\s*<\/h[1-3]>)/gi,'<div class="action-list-header">$1<button class="action-list-add-btn" onclick="addActionListToTodo()">+ Todo</button></div>'),t}function Qe(){if(document.getElementById("summaryModal"))return;document.body.insertAdjacentHTML("beforeend",`
    ...
    `)}async function Be(e,t,o,n,s){if(!T.getUser()){x();return}Qe();let a=document.getElementById("summaryModal"),i=document.getElementById("summaryModalTitle"),d=document.getElementById("summaryModalBody"),m=document.getElementById("summaryModalFooter");if(p=e,L=t,j=o,Jt=n,Qt=s,ie=!0,window._currentSummaryNewsId=e,window._currentSummaryNewsTitle=t,window._currentSummaryNewsUrl=o,Je(),i){let l=t&&t.length>50?t.substring(0,50)+"...":t||"AI \u603B\u7ED3";i.textContent=`\u2728 ${l}`}a.classList.add("open"),document.body.style.overflow="hidden",d.innerHTML=`
    ...
    `,m.style.display="none",U(),de=setTimeout(()=>{console.log("[Summary] 5s timeout, opening original article");let l=document.getElementById("summaryModal");l&&(l.classList.remove("open"),document.body.style.overflow=""),ie=!1,p=null,o&&window.open(o,"_blank","noopener,noreferrer")},Vt),le=setTimeout(()=>{Zt(o,n,s),d.innerHTML=`
        ...
        `},Xt);try{let l=await fetch(`/api/summary/failures/check?url=${encodeURIComponent(o)}`);if(l.ok){let b=await l.json();if(console.log("[Summary] Check result:",b),b.summarizable)b.warning&&console.log("[Summary] Warning:",b.warning);else{console.log("[Summary] URL blocked, opening original:",o),U();let B=document.getElementById("summaryModal");B&&(B.classList.remove("open"),document.body.style.overflow=""),ie=!1,p=null,window.open(o,"_blank");return}}let c=await fetch("/api/summary/stream",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:o,title:t,news_id:e,source_id:n,source_name:s})});if(!c.ok){let b=await c.json();throw new Error(b.detail||"\u751F\u6210\u5931\u8D25")}let f=c.body.getReader(),y=new TextDecoder,h="",S="other",_="\u5176\u4ED6",P=!1,M=null;for(;;){let{done:b,value:B}=await f.read();if(b)break;let g=y.decode(B,{stream:!0}).split(`
`);for(let J of g)if(J.startsWith("data: "))try{let u=JSON.parse(J.slice(6));switch(u.type){case"status":let Y=document.getElementById("summaryStatusText");Y&&(Y.textContent=u.message);break;case"type":S=u.article_type,_=u.article_type_name,window._currentTypeConfidence=u.confidence||0;break;case"chunk":P||(P=!0,U(),d.innerHTML=`
                                    <div class="summary-content summary-streaming" id="summaryStreamContent">
                                        <div class="summary-cursor"></div>
                                    </div>
                                `),h+=u.content;let D=document.getElementById("summaryStreamContent");if(D){let v=h;v=v.replace(/\[TAGS_?START\][\s\S]*$/gi,""),D.innerHTML=q(v)+'<span class="summary-cursor">\u258C</span>',D.scrollTop=D.scrollHeight}break;case"cached":U(),h=u.summary,S=u.article_type,_=u.article_type_name,M=u.token_usage||null;let O=u.feedback||null,ft=u.token_balance!==void 0?{token_balance:u.token_balance,tokens_used:u.tokens_used,default_tokens:1e5}:null,pt=Ie(h);if(d.innerHTML=`
                                <div class="summary-content">
                                    ${q(pt)}
                                </div>
                            `,ce(o,S,_,!0,M,O,ft),ue(e,!0),u.tags&&window.ArticleTags){console.log("[Summary] Applying cached tags for newsId:",e,"tags:",u.tags);let v=document.querySelector(`.news-item[data-news-id="${e}"]`);v||(v=document.querySelector(`.news-item[data-url="${o}"]`)),v&&(console.log("[Summary] Found news item for cached, applying tags"),window.ArticleTags.applyTags(v,u.tags),v.dataset.tagsLoaded="true")}return;case"done":M=u.token_usage||null;let yt=u.token_balance!==void 0?{token_balance:u.token_balance,tokens_used:u.tokens_used,default_tokens:1e5}:null,ye=document.getElementById("summaryStreamContent");if(ye){ye.classList.remove("summary-streaming");let v=Ie(h);ye.innerHTML=q(v)}let gt=window._currentTypeConfidence||0;if(ce(o,S,_,!1,M,null,yt,gt),ue(e,!0),u.tags&&window.ArticleTags){console.log("[Summary] Applying tags for newsId:",e,"tags:",u.tags);let v=document.querySelector(`.news-item[data-news-id="${e}"]`);v||(v=document.querySelector(`.news-item[data-url="${o}"]`)),v?(console.log("[Summary] Found news item, applying tags"),window.ArticleTags.applyTags(v,u.tags),v.dataset.tagsLoaded="true"):console.log("[Summary] News item not found in DOM")}break;case"short_content":U(),d.innerHTML=`
            ...
            `;else{Ve();return}}}function ce(e,t,o,n,s,r=null,a=null,i=null){let d=document.getElementById("summaryModalFooter"),m=eo[t]||"\u{1F4DD}",l="",c=s?.total_tokens||0;c>0&&(l=`<span class="summary-token-tag" title="\u672C\u6B21\u6D88\u8017">\u{1FA99} ${to(c)}</span>`);let f=r==="up"?"active":"",y=r==="down"?"active":"";d.innerHTML=`
    ...
    `,d.style.display="flex"}async function oo(e){if(!p)return;let t=document.querySelectorAll(".summary-feedback-btn"),o=document.querySelector(`.summary-feedback-btn[data-vote="${e}"]`),s=o?.classList.contains("active")?"none":e;t.forEach(r=>r.classList.remove("active")),s!=="none"&&o?.classList.add("active");try{let r=await fetch(`/api/summary/${encodeURIComponent(p)}/feedback`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({vote:s})});r.ok||console.error("[Summary] Feedback failed:",await r.text())}catch(r){console.error("[Summary] Feedback error:",r)}}function Ve(){let e=document.getElementById("summaryModal");e&&(e.classList.remove("open"),document.body.style.overflow=""),U(),ie=!1,p=null}function Xe(){let e=document.querySelector(`.news-summary-btn[data-news-id="${p}"]`);if(e){let t=e.dataset.title,o=e.dataset.url,n=e.dataset.sourceId,s=e.dataset.sourceName;Be(p,t,o,n,s)}}async function no(){if(p){try{await fetch(`/api/summary/${encodeURIComponent(p)}`,{method:"DELETE"})}catch(e){console.error("[Summary] Delete error:",e)}Xe()}}async function so(e,t,o,n,s){let r=decodeURIComponent(t),a=decodeURIComponent(o),i=decodeURIComponent(s);ro(e,r,a,n,i)}async function ro(e,t,o,n,s){if(!T.getUser()){x();return}Qe();let a=document.getElementById("summaryModal"),i=document.getElementById("summaryModalBody"),d=document.getElementById("summaryModalFooter");p=e,L=t,j=o,i.innerHTML=`
        <div class="summary-loading">
            <div class="summary-loading-spinner"></div>
            <div class="summary-loading-text">
    ...
    `,d.style.display="none";try{let m=await fetch("/api/summary/stream?force=1",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:o,title:t,news_id:e,source_id:n,source_name:s})});if(!m.ok){let P=await m.json();throw new Error(P.detail||"\u751F\u6210\u5931\u8D25")}let l=m.body.getReader(),c=new TextDecoder,f="",y="other",h="\u5176\u4ED6",S=!1,_=null;for(;;){let{done:P,value:M}=await l.read();if(P)break;let B=c.decode(M,{stream:!0}).split(`
`);for(let pe of B)if(pe.startsWith("data: "))try{let g=JSON.parse(pe.slice(6));switch(g.type){case"status":let J=document.getElementById("summaryStatusText");J&&(J.textContent=g.message);break;case"type":y=g.article_type,h=g.article_type_name;break;case"chunk":S||(S=!0,i.innerHTML=`
                                    <div class="summary-content summary-streaming" id="summaryStreamContent">
                                        <div class="summary-cursor"></div>
                                    </div>
                                `),f+=g.content;let u=document.getElementById("summaryStreamContent");u&&(u.innerHTML=q(f)+'<span class="summary-cursor">\u258C</span>',u.scrollTop=u.scrollHeight);break;case"done":_=g.token_usage||null;let Y=g.token_balance!==void 0?{token_balance:g.token_balance,tokens_used:g.tokens_used,default_tokens:1e5}:null,D=document.getElementById("summaryStreamContent");if(D&&(D.classList.remove("summary-streaming"),D.innerHTML=q(f)),ce(o,y,h,!1,_,null,Y),ue(e,!0),g.tags&&window.ArticleTags){let O=document.querySelector(`.news-item[data-news-id="${e}"]`);O||(O=document.querySelector(`.news-item[data-url="${o}"]`)),O&&(window.ArticleTags.applyTags(O,g.tags),O.dataset.tagsLoaded="true")}break;case"error":throw new Error(g.message)}}catch(g){if(g.message&&!g.message.includes("JSON"))throw g}}}catch(m){console.error("[Summary] Force error:",m),i.innerHTML=`
    ...
    `;t.innerHTML=o}function Ye(){let e=document.getElementById("favoritesPanelBody");if(!e)return;let t=fe();t.length>0?e.innerHTML=`
        ...
        `}async function lt(){let e=document.getElementById("favoritesPanelBody");if(!e)return;if(e.innerHTML='<div class="favorites-loading">\u52A0\u8F7D\u4E2D...</div>',!T.getUser()){Ye();return}let o=await po();if(o.needsAuth){Ye();return}if(o.error){e.innerHTML=`
            <div class="favorites-empty">
        ...
        `;return}go(o.favorites)}function vo(){if(!T.getUser()){x();return}let t=document.getElementById("favoritesPanel"),o=document.getElementById("favoritesOverlay");t&&(o||(o=document.createElement("div"),o.id="favoritesOverlay",o.className="favorites-overlay",o.onclick=ct,document.body.appendChild(o)),me=!me,me?(t.classList.add("open"),o.classList.add("open"),lt()):(t.classList.remove("open"),o.classList.remove("open")))}function ct(){let e=document.getElementById("favoritesPanel"),t=document.getElementById("favoritesOverlay");me=!1,e&&e.classList.remove("open"),t&&t.classList.remove("open")}async function wo(e){if((await rt(e)).ok){let o=document.querySelector(`.favorite-item[data-news-id="${e}"]`);o&&o.remove();let n=document.querySelector(`.news-favorite-btn[data-news-id="${e}"]`);n&&(n.classList.remove("favorited"),n.textContent="\u2606");let s=document.querySelector(".favorites-list");s&&s.children.length===0&&lt()}}function ho(e,t,o,n,s,r){if(e.preventDefault(),e.stopPropagation(),!T.getUser()){x();return}let i=e.currentTarget;it({news_id:t,title:o,url:n,source_id:s||"",source_name:r||""},i)}function bo(){try{let e=localStorage.getItem(nt);if(e){let t=parseInt(e,10);if(t>=Ce&&t<=$e)return t}}catch{}return fo}function Ze(e){try{localStorage.setItem(nt,String(e)),Z.saveSidebarWidths({favorites_width:e})}catch{}}function To(e){let t=document.getElementById("favoritesPanel");t&&(t.style.width=e+"px")}function et(){let e=document.getElementById("favoritesPanel"),t=document.getElementById("favoritesResizeHandle");if(!e||!t)return;let o=bo();To(o);let n=0,s=0;function r(c){c.preventDefault(),H=!0,n=c.clientX,s=e.offsetWidth,e.classList.add("resizing"),t.classList.add("active"),document.addEventListener("mousemove",a),document.addEventListener("mouseup",i)}function a(c){if(!H)return;let f=n-c.clientX,y=s+f;y=Math.max(Ce,Math.min($e,y)),e.style.width=y+"px"}function i(){H&&(H=!1,e.classList.remove("resizing"),t.classList.remove("active"),document.removeEventListener("mousemove",a),document.removeEventListener("mouseup",i),Ze(e.offsetWidth))}function d(c){c.touches.length===1&&(c.preventDefault(),H=!0,n=c.touches[0].clientX,s=e.offsetWidth,e.classList.add("resizing"),t.classList.add("active"),document.addEventListener("touchmove",m,{passive:!1}),document.addEventListener("touchend",l))}function m(c){if(!H||c.touches.length!==1)return;c.preventDefault();let f=n-c.touches[0].clientX,y=s+f;y=Math.max(Ce,Math.min($e,y)),e.style.width=y+"px"}function l(){H&&(H=!1,e.classList.remove("resizing"),t.classList.remove("active"),document.removeEventListener("touchmove",m),document.removeEventListener("touchend",l),Ze(e.offsetWidth))}t.addEventListener("mousedown",r),t.addEventListener("touchstart",d,{passive:!1})}function tt(){document.addEventListener("click",e=>{let t=e.target.closest(".news-favorite-btn");if(!t)return;if(e.preventDefault(),e.stopPropagation(),!T.getUser()){x();return}let n=t.closest(".news-item");if(!n)return;let s=n.dataset.id||n.dataset.newsId,r=n.dataset.url,a=n.querySelector(".news-title"),i=a?a.textContent.trim():"",d=n.closest(".platform-card"),m=d?d.dataset.platform:"",l=d?d.querySelector(".platform-name"):null,c=l?l.textContent.replace("\u{1F4F1}","").trim():"";it({news_id:s,title:i,url:r,source_id:m,source_name:c},t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{et(),tt()}):(et(),tt());async function ut(e){let t=document.getElementById(`summary-${e}`),o=document.querySelector(`.favorite-item[data-news-id="${e}"] .favorite-summary-btn`);if(!(!t||!o)){if(o.classList.contains("has-summary")){mt(e);return}o.disabled=!0,o.textContent="\u23F3",o.title="\u751F\u6210\u4E2D...",t.style.display="block",t.innerHTML=`
        <div class="summary-loading">
            <div class="summary-loading-spinner"></div>
