...
TAG_NORMALIZATION = {
    ...
    "synonyms": {
        ...
        "cursor_agent": "cursor",
        "cursor_agent_scaling": "cursor",
        "cursor_agent_trace": "cursor",
        "cursor_code_indexing": "cursor",
        "cursor_no_kpi": "cursor",
        "cursor_online": "cursor",
        "cursor_overflow": "cursor",
        "cursor_decline": "cursor",
        "claude_vs_cursor": "cursor",
        "github_copilot": "copilot",
        "github_copilot_cli": "copilot",
        "copilot_plus": "copilot",
        "copilot_data_leak": "copilot",
        "copilot_data_leak_risk": "copilot",
        "copilot_data_collection": "copilot",
        "copilot_leak": "copilot",
        "copilot_monetization": "copilot",
        "copilot_incident": "copilot",
        "microsoft_copilot": "copilot",
        "microsoft_ai_copilot": "copilot",
        "microsoft_copilot_ai_strategy": "copilot",
        "windows_copilot_integration": "copilot",
        "windows_copilot_disable": "copilot",
        "dotnet_copilot": "copilot",
        "ai_copilot_enterprise": "copilot",
        "ai_copilot_adoption": "copilot",
        "chrome_copilot_alternative": "copilot",
        "windsurf_arena_mode": "windsurf",
        "openclaw_moltbook": "openclaw",
        "openclaw_engineering": "openclaw",
        "openclaw_summit": "openclaw",
        "openclaw_agent_teams": "openclaw",
        "openclaw_agent_skill": "openclaw",
        "openclaw_memory_isolation": "openclaw",
        "openclaw_auto_evolution": "openclaw",
        "openclaw_safety_governance": "openclaw",
        "openclaw_security_governance": "openclaw",
        "openclaw_vulnerability": "openclaw",
        "openclaw_soul": "openclaw",
        "openclaw_install": "openclaw",
        "openclaw_ai": "openclaw",
        "openclaws": "openclaw",
        "openclawd": "openclaw",
        "unitree_openclaw": "openclaw",
        "trae_solo": "trae",
        "trae_skills": "trae",
...
PRODUCT_PARENT_MAP = {
    ...
    # AI 编程工具
    "cursor": "ai_coding_tools", "copilot": "ai_coding_tools",
    "windsurf": "ai_coding_tools", "cline": "ai_coding_tools",
    "openclaw": "ai_coding_tools", "trae": "ai_coding_tools",
    "aider": "ai_coding_tools", "antigravity": "ai_coding_tools",
    "kiro": "ai_coding_tools", "claude_code": "ai_coding_tools",
    "codex": "ai_coding_tools",
}
